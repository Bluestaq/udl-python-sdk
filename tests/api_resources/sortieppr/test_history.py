...
class TestHistory:
    ...
    def test_raw_response_list(self, client: Unifieddatalibrary) -> None:
        response = client.sortieppr.history.with_raw_response.list(
            id_sortie="idSortie",
        )
    ...
    def test_streaming_response_list(self, client: Unifieddatalibrary) -> None:
        with client.sortieppr.history.with_streaming_response.list(
            id_sortie="idSortie",
        ) as response:
    ...
    def test_raw_response_aodr(self, client: Unifieddatalibrary) -> None:
        response = client.sortieppr.history.with_raw_response.aodr(
            id_sortie="idSortie",
        )
    ...
    def test_streaming_response_aodr(self, client: Unifieddatalibrary) -> None:
        with client.sortieppr.history.with_streaming_response.aodr(
            id_sortie="idSortie",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_count(self, client: Unifieddatalibrary) -> None:
        response = client.sortieppr.history.with_raw_response.count(
            id_sortie="idSortie",
        )
    ...
    def test_streaming_response_count(self, client: Unifieddatalibrary) -> None:
        with client.sortieppr.history.with_streaming_response.count(
            id_sortie="idSortie",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncHistory:
    ...
    async def test_raw_response_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.sortieppr.history.with_raw_response.list(
            id_sortie="idSortie",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.sortieppr.history.with_streaming_response.list(
            id_sortie="idSortie",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.sortieppr.history.with_raw_response.aodr(
            id_sortie="idSortie",
        )
    ...
    async def test_streaming_response_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.sortieppr.history.with_streaming_response.aodr(
            id_sortie="idSortie",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.sortieppr.history.with_raw_response.count(
            id_sortie="idSortie",
        )
    ...
    async def test_streaming_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.sortieppr.history.with_streaming_response.count(
            id_sortie="idSortie",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

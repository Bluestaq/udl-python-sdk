...
class TestAirtaskingorders:
    ...
    def test_method_list(self, client: Unifieddatalibrary) -> None:
        ...
        assert_matches_type(SyncOffsetPage[AirtaskingorderAbridged], airtaskingorder, path=["response"])
...
class TestAsyncAirtaskingorders:
    ...
    async def test_method_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        ...
        assert_matches_type(AsyncOffsetPage[AirtaskingorderAbridged], airtaskingorder, path=["response"])

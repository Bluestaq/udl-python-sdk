...
class TestRfobservation:
    ...
    def test_method_list(self, client: Unifieddatalibrary) -> None:
        ...
        assert_matches_type(SyncOffsetPage[RfobservationListResponse], rfobservation, path=["response"])
...
class TestAsyncRfobservation:
    ...
    async def test_method_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        ...
        assert_matches_type(AsyncOffsetPage[RfobservationListResponse], rfobservation, path=["response"])

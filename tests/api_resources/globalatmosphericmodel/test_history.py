...
class TestHistory:
    ...
    def test_streaming_response_count(self, client: Unifieddatalibrary) -> None:
        with client.globalatmosphericmodel.history.with_streaming_response.count(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
    ...
    def test_raw_response_query(self, client: Unifieddatalibrary) -> None:
        response = client.globalatmosphericmodel.history.with_raw_response.query(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_streaming_response_query(self, client: Unifieddatalibrary) -> None:
        with client.globalatmosphericmodel.history.with_streaming_response.query(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_write_aodr(self, client: Unifieddatalibrary) -> None:
        response = client.globalatmosphericmodel.history.with_raw_response.write_aodr(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_streaming_response_write_aodr(self, client: Unifieddatalibrary) -> None:
        with client.globalatmosphericmodel.history.with_streaming_response.write_aodr(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncHistory:
    ...
    async def test_streaming_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.globalatmosphericmodel.history.with_streaming_response.count(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_query(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.globalatmosphericmodel.history.with_raw_response.query(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    async def test_streaming_response_query(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.globalatmosphericmodel.history.with_streaming_response.query(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_write_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.globalatmosphericmodel.history.with_raw_response.write_aodr(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    async def test_streaming_response_write_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.globalatmosphericmodel.history.with_streaming_response.write_aodr(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

...
class TestSensorobservationtype:
    ...
    def test_method_list(self, client: Unifieddatalibrary) -> None:
        ...
        assert_matches_type(SyncOffsetPage[SensorobservationtypeListResponse], sensorobservationtype, path=["response"])
    ...
    def test_streaming_response_list(self, client: Unifieddatalibrary) -> None:
        with client.sensorobservationtype.with_streaming_response.list() as response:
            ...
            sensorobservationtype = response.parse()
            assert_matches_type(
                SyncOffsetPage[SensorobservationtypeListResponse], sensorobservationtype, path=["response"]
            )
...
class TestAsyncSensorobservationtype:
    ...
    async def test_method_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        ...
        assert_matches_type(
            AsyncOffsetPage[SensorobservationtypeListResponse], sensorobservationtype, path=["response"]
        )

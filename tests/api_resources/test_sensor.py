            ...
            sensorcharacteristics=[
                {
                    ...
                    "acceptable_sat_id_formats": ["5-DIGIT", "ALPHA-5"],
                    ...
                    "max_data_transmission_rate": 10.23,
                    ...
                    "run_mean_codes": [0, 5],
                    "search_pattern_points": [0, 40.1, 60.1],
                    "settle_time": 4.4,
                    ...
                    "tasking_channels": ["AD-HOC", "DAILY", "CTL"],

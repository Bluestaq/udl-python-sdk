...
class TestSarobservation:
    ...
    def test_streaming_response_list(self, client: Unifieddatalibrary) -> None:
        with client.sarobservation.with_streaming_response.list(
            collection_start=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_count(self, client: Unifieddatalibrary) -> None:
        response = client.sarobservation.with_raw_response.count(
            collection_start=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_streaming_response_count(self, client: Unifieddatalibrary) -> None:
        with client.sarobservation.with_streaming_response.count(
            collection_start=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_create_bulk(self, client: Unifieddatalibrary) -> None:
        sarobservation = client.sarobservation.create_bulk(
            body=[
                {
                    "classification_marking": "U",
                    "collection_end": parse_datetime("2023-04-22T17:38:10.20177Z"),
    ...
    def test_raw_response_create_bulk(self, client: Unifieddatalibrary) -> None:
        response = client.sarobservation.with_raw_response.create_bulk(
            body=[
                {
                    "classification_marking": "U",
                    "collection_end": parse_datetime("2023-04-22T17:38:10.20177Z"),
    ...
    def test_streaming_response_create_bulk(self, client: Unifieddatalibrary) -> None:
        with client.sarobservation.with_streaming_response.create_bulk(
            body=[
                {
                    "classification_marking": "U",
                    "collection_end": parse_datetime("2023-04-22T17:38:10.20177Z"),
    ...
    def test_method_queryhelp(self, client: Unifieddatalibrary) -> None:
        sarobservation = client.sarobservation.queryhelp()
        assert sarobservation is None

    @parametrize
    def test_raw_response_queryhelp(self, client: Unifieddatalibrary) -> None:
        response = client.sarobservation.with_raw_response.queryhelp()
    ...
    def test_streaming_response_queryhelp(self, client: Unifieddatalibrary) -> None:
        with client.sarobservation.with_streaming_response.queryhelp() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_tuple(self, client: Unifieddatalibrary) -> None:
        response = client.sarobservation.with_raw_response.tuple(
            collection_start=parse_datetime("2019-12-27T18:11:19.117Z"),
            columns="columns",
        )
    ...
    def test_streaming_response_tuple(self, client: Unifieddatalibrary) -> None:
        with client.sarobservation.with_streaming_response.tuple(
            collection_start=parse_datetime("2019-12-27T18:11:19.117Z"),
            columns="columns",
        ) as response:
            assert not response.is_closed
...
class TestAsyncSarobservation:
    ...
    async def test_streaming_response_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.sarobservation.with_streaming_response.list(
            collection_start=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.sarobservation.with_raw_response.count(
            collection_start=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    async def test_streaming_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.sarobservation.with_streaming_response.count(
            collection_start=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_create_bulk(self, async_client: AsyncUnifieddatalibrary) -> None:
        sarobservation = await async_client.sarobservation.create_bulk(
            body=[
                {
                    "classification_marking": "U",
                    "collection_end": parse_datetime("2023-04-22T17:38:10.20177Z"),
    ...
    async def test_raw_response_create_bulk(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.sarobservation.with_raw_response.create_bulk(
            body=[
                {
                    "classification_marking": "U",
                    "collection_end": parse_datetime("2023-04-22T17:38:10.20177Z"),
    ...
    async def test_streaming_response_create_bulk(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.sarobservation.with_streaming_response.create_bulk(
            body=[
                {
                    "classification_marking": "U",
                    "collection_end": parse_datetime("2023-04-22T17:38:10.20177Z"),
    ...
    async def test_method_queryhelp(self, async_client: AsyncUnifieddatalibrary) -> None:
        sarobservation = await async_client.sarobservation.queryhelp()
        assert sarobservation is None

    @parametrize
    async def test_raw_response_queryhelp(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.sarobservation.with_raw_response.queryhelp()
    ...
    async def test_streaming_response_queryhelp(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.sarobservation.with_streaming_response.queryhelp() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_tuple(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.sarobservation.with_raw_response.tuple(
            collection_start=parse_datetime("2019-12-27T18:11:19.117Z"),
            columns="columns",
        )
    ...
    async def test_streaming_response_tuple(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.sarobservation.with_streaming_response.tuple(
            collection_start=parse_datetime("2019-12-27T18:11:19.117Z"),
            columns="columns",
        ) as response:
            assert not response.is_closed

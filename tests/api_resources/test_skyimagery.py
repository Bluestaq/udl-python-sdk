...
class TestSkyimagery:
    ...
    def test_method_file_create(self, client: Unifieddatalibrary) -> None:
        skyimagery = client.skyimagery.file_create(
    ...
    def test_method_file_create_with_all_params(self, client: Unifieddatalibrary) -> None:
        skyimagery = client.skyimagery.file_create(
            ...
            exp_end_time=parse_datetime("2021-01-01T01:01:01.123456Z"),
            filename="filename.jpg",
            filesize=371945,
            frame_fov_height=21.23,
            frame_fov_width=21.23,
            frame_height_pixels=1,
            frame_width_pixels=1,
            id_attitude_set="d039ba29-52f4-4839-8a8f-e85fa416aec5",
            id_sensor="420",
            id_soi_set="531093d0-e9b0-475b-687aeeefefd9",
            image_set_id="imageSetId",
            image_set_length=9,
            image_source_info="imageSourceInfo",
            origin="THIRD_PARTY_DATASOURCE",
            orig_object_id="X15-23452",
            orig_sensor_id="origSensorId",
            pixel_bit_depth=1,
            pixel_fov_height=321.123,
            pixel_fov_width=321.123,
            sat_no=25544,
            senalt=14.483619321,
            senlat=-33.283048,
            senlon=149.372549,
            sen_quat=[0.03, 0.02, 0.01, 0.012],
            sen_quat_dot=[0.03, 0.02, 0.01, 0.012],
            senx=14.52,
            seny=32.41,
            senz=376.12,
            sequence_id=1,
            tags=["PROVIDER_TAG1", "PROVIDER_TAG2"],
            top_left_start_az=146.321,
            top_left_start_el=146.321,
            top_left_stop_az=3.7,
            top_left_stop_el=34.233,
    ...
    def test_raw_response_file_create(self, client: Unifieddatalibrary) -> None:
        response = client.skyimagery.with_raw_response.file_create(
            classification_marking="U",
            data_mode="REAL",
            exp_start_time=parse_datetime("2021-01-01T01:01:01.123456Z"),
            image_type="imageType",
    ...
    def test_streaming_response_file_create(self, client: Unifieddatalibrary) -> None:
        with client.skyimagery.with_streaming_response.file_create(
            classification_marking="U",
            data_mode="REAL",
            exp_start_time=parse_datetime("2021-01-01T01:01:01.123456Z"),
            image_type="imageType",
...
class TestAsyncSkyimagery:
    ...
    async def test_method_file_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        skyimagery = await async_client.skyimagery.file_create(
            classification_marking="U",
            data_mode="REAL",
            exp_start_time=parse_datetime("2021-01-01T01:01:01.123456Z"),
            image_type="imageType",
    ...
    async def test_raw_response_file_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.skyimagery.with_raw_response.file_create(
            classification_marking="U",
            data_mode="REAL",
            exp_start_time=parse_datetime("2021-01-01T01:01:01.123456Z"),
            image_type="imageType",
    ...
    async def test_streaming_response_file_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.skyimagery.with_streaming_response.file_create(
            classification_marking="U",
            data_mode="REAL",
            exp_start_time=parse_datetime("2021-01-01T01:01:01.123456Z"),
            image_type="imageType",

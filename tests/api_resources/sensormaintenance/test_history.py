...
from unifieddatalibrary.types.sensormaintenance import (
...
class TestHistory:
    ...
    def test_raw_response_retrieve(self, client: Unifieddatalibrary) -> None:
        response = client.sensormaintenance.history.with_raw_response.retrieve()
    ...
    def test_streaming_response_retrieve(self, client: Unifieddatalibrary) -> None:
        with client.sensormaintenance.history.with_streaming_response.retrieve() as response:
    ...
    def test_raw_response_aodr(self, client: Unifieddatalibrary) -> None:
        response = client.sensormaintenance.history.with_raw_response.aodr()
    ...
    def test_streaming_response_aodr(self, client: Unifieddatalibrary) -> None:
        with client.sensormaintenance.history.with_streaming_response.aodr() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_count(self, client: Unifieddatalibrary) -> None:
        response = client.sensormaintenance.history.with_raw_response.count()
    ...
    def test_streaming_response_count(self, client: Unifieddatalibrary) -> None:
        with client.sensormaintenance.history.with_streaming_response.count() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncHistory:
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.sensormaintenance.history.with_raw_response.retrieve()
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.sensormaintenance.history.with_streaming_response.retrieve() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.sensormaintenance.history.with_raw_response.aodr()
    ...
    async def test_streaming_response_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.sensormaintenance.history.with_streaming_response.aodr() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.sensormaintenance.history.with_raw_response.count()
    ...
    async def test_streaming_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.sensormaintenance.history.with_streaming_response.count() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

...
from unifieddatalibrary.types.featureassessment import (
...
class TestHistory:
    ...
    def test_streaming_response_count(self, client: Unifieddatalibrary) -> None:
        with client.featureassessment.history.with_streaming_response.count(
            id_analytic_imagery="idAnalyticImagery",
        ) as response:
    ...
    def test_raw_response_query(self, client: Unifieddatalibrary) -> None:
        response = client.featureassessment.history.with_raw_response.query(
            id_analytic_imagery="idAnalyticImagery",
        )
    ...
    def test_streaming_response_query(self, client: Unifieddatalibrary) -> None:
        with client.featureassessment.history.with_streaming_response.query(
            id_analytic_imagery="idAnalyticImagery",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_write_aodr(self, client: Unifieddatalibrary) -> None:
        response = client.featureassessment.history.with_raw_response.write_aodr(
            id_analytic_imagery="idAnalyticImagery",
        )
    ...
    def test_streaming_response_write_aodr(self, client: Unifieddatalibrary) -> None:
        with client.featureassessment.history.with_streaming_response.write_aodr(
            id_analytic_imagery="idAnalyticImagery",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncHistory:
    ...
    async def test_streaming_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.featureassessment.history.with_streaming_response.count(
            id_analytic_imagery="idAnalyticImagery",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_query(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.featureassessment.history.with_raw_response.query(
            id_analytic_imagery="idAnalyticImagery",
        )
    ...
    async def test_streaming_response_query(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.featureassessment.history.with_streaming_response.query(
            id_analytic_imagery="idAnalyticImagery",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_write_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.featureassessment.history.with_raw_response.write_aodr(
            id_analytic_imagery="idAnalyticImagery",
        )
    ...
    async def test_streaming_response_write_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.featureassessment.history.with_streaming_response.write_aodr(
            id_analytic_imagery="idAnalyticImagery",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

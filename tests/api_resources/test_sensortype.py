...
class TestSensortype:
    ...
    def test_method_list(self, client: Unifieddatalibrary) -> None:
        ...
        assert_matches_type(SyncOffsetPage[SensortypeListResponse], sensortype, path=["response"])
...
class TestAsyncSensortype:
    ...
    async def test_method_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        ...
        assert_matches_type(AsyncOffsetPage[SensortypeListResponse], sensortype, path=["response"])

...
class TestItem:
    ...
    def test_method_update_with_all_params(self, client: Unifieddatalibrary) -> None:
        item = client.item.update(
            ...
            source="Bluestaq",
            type="CARGO",
            id_2="22f1f6da-a568-655a-ea37-76d013d04853",
            acc_sys_keys=["System key1", "System key2"],
            acc_sys_notes="Accepting System Notes",
            acc_system="Accepting System",
            acc_sys_values=["System value1", "System value2"],
    ...
    def test_raw_response_file_create(self, client: Unifieddatalibrary) -> None:
        response = client.item.with_raw_response.file_create(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "REAL",
    ...
    def test_streaming_response_file_create(self, client: Unifieddatalibrary) -> None:
        with client.item.with_streaming_response.file_create(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "REAL",
...
class TestAsyncItem:
    ...
    async def test_method_file_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        item = await async_client.item.file_create(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "REAL",
    ...
    async def test_raw_response_file_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.item.with_raw_response.file_create(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "REAL",
    ...
    async def test_streaming_response_file_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.item.with_streaming_response.file_create(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "REAL",

...
class TestManeuvers:
    ...
    def test_method_create_with_all_params(self, client: Unifieddatalibrary) -> None:
        maneuver = client.maneuvers.create(
            ...
            num_accel_points=3,
            num_obs=10,
            od_fit_end_time=parse_datetime("2023-11-16T03:55:51Z"),
            ...
            pre_vel_y=0.24876,
            pre_vel_z=0.0067352,
            report_time=parse_datetime("2023-11-16T04:15:00.0001Z"),
            sat_no=12,
    ...
    def test_method_file_create(self, client: Unifieddatalibrary) -> None:
        maneuver = client.maneuvers.file_create(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "REAL",
    ...
    def test_raw_response_file_create(self, client: Unifieddatalibrary) -> None:
        response = client.maneuvers.with_raw_response.file_create(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "REAL",
    ...
    def test_streaming_response_file_create(self, client: Unifieddatalibrary) -> None:
        with client.maneuvers.with_streaming_response.file_create(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "REAL",
...
class TestAsyncManeuvers:
    ...
    async def test_method_file_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        maneuver = await async_client.maneuvers.file_create(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "REAL",
    ...
    async def test_raw_response_file_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.maneuvers.with_raw_response.file_create(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "REAL",
    ...
    async def test_streaming_response_file_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.maneuvers.with_streaming_response.file_create(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "REAL",

...
class TestRfbandtype:
    ...
    def test_method_list(self, client: Unifieddatalibrary) -> None:
        ...
        assert_matches_type(SyncOffsetPage[RfbandtypeListResponse], rfbandtype, path=["response"])
    ...
    def test_streaming_response_list(self, client: Unifieddatalibrary) -> None:
        with client.rfbandtype.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: Unifieddatalibrary) -> None:
        rfbandtype = client.rfbandtype.delete(
            "id",
        )
        assert rfbandtype is None
    ...
    def test_raw_response_delete(self, client: Unifieddatalibrary) -> None:
        response = client.rfbandtype.with_raw_response.delete(
            "id",
        )
    ...
    def test_streaming_response_delete(self, client: Unifieddatalibrary) -> None:
        with client.rfbandtype.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Unifieddatalibrary) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.rfbandtype.with_raw_response.delete(
                "",
            )
    ...
    def test_streaming_response_count(self, client: Unifieddatalibrary) -> None:
        with client.rfbandtype.with_streaming_response.count() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_queryhelp(self, client: Unifieddatalibrary) -> None:
        rfbandtype = client.rfbandtype.queryhelp()
        assert rfbandtype is None

    @parametrize
    def test_raw_response_queryhelp(self, client: Unifieddatalibrary) -> None:
        response = client.rfbandtype.with_raw_response.queryhelp()
    ...
    def test_streaming_response_queryhelp(self, client: Unifieddatalibrary) -> None:
        with client.rfbandtype.with_streaming_response.queryhelp() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_tuple(self, client: Unifieddatalibrary) -> None:
        response = client.rfbandtype.with_raw_response.tuple(
            columns="columns",
        )
    ...
    def test_streaming_response_tuple(self, client: Unifieddatalibrary) -> None:
        with client.rfbandtype.with_streaming_response.tuple(
            columns="columns",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncRfbandtype:
    ...
    async def test_raw_response_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        rfbandtype = await response.parse()
        assert rfbandtype is None
    ...
    async def test_method_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        ...
        assert_matches_type(AsyncOffsetPage[RfbandtypeListResponse], rfbandtype, path=["response"])
    ...
    async def test_streaming_response_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.rfbandtype.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncUnifieddatalibrary) -> None:
        rfbandtype = await async_client.rfbandtype.delete(
            "id",
        )
        assert rfbandtype is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.rfbandtype.with_raw_response.delete(
            "id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.rfbandtype.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncUnifieddatalibrary) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.rfbandtype.with_raw_response.delete(
                "",
            )
    ...
    async def test_streaming_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.rfbandtype.with_streaming_response.count() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_queryhelp(self, async_client: AsyncUnifieddatalibrary) -> None:
        rfbandtype = await async_client.rfbandtype.queryhelp()
        assert rfbandtype is None

    @parametrize
    async def test_raw_response_queryhelp(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.rfbandtype.with_raw_response.queryhelp()
    ...
    async def test_streaming_response_queryhelp(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.rfbandtype.with_streaming_response.queryhelp() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_tuple(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.rfbandtype.with_raw_response.tuple(
            columns="columns",
        )
    ...
    async def test_streaming_response_tuple(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.rfbandtype.with_streaming_response.tuple(
            columns="columns",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

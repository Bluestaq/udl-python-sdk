...
from unifieddatalibrary.types.h3geo import (
...
class TestHistory:
    ...
    def test_method_ador(self, client: Unifieddatalibrary) -> None:
        history = client.h3geo.history.ador(
    ...
    def test_raw_response_ador(self, client: Unifieddatalibrary) -> None:
        response = client.h3geo.history.with_raw_response.ador(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_streaming_response_ador(self, client: Unifieddatalibrary) -> None:
        with client.h3geo.history.with_streaming_response.ador(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
    ...
    def test_method_count(self, client: Unifieddatalibrary) -> None:
        history = client.h3geo.history.count(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_raw_response_count(self, client: Unifieddatalibrary) -> None:
        response = client.h3geo.history.with_raw_response.count(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_streaming_response_count(self, client: Unifieddatalibrary) -> None:
        with client.h3geo.history.with_streaming_response.count(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_query(self, client: Unifieddatalibrary) -> None:
        history = client.h3geo.history.query(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_raw_response_query(self, client: Unifieddatalibrary) -> None:
        response = client.h3geo.history.with_raw_response.query(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_streaming_response_query(self, client: Unifieddatalibrary) -> None:
        with client.h3geo.history.with_streaming_response.query(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncHistory:
    ...
    async def test_method_ador(self, async_client: AsyncUnifieddatalibrary) -> None:
        history = await async_client.h3geo.history.ador(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
        assert history is None
    ...
    async def test_raw_response_ador(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.h3geo.history.with_raw_response.ador(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    async def test_streaming_response_ador(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.h3geo.history.with_streaming_response.ador(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        history = await async_client.h3geo.history.count(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
        assert_matches_type(str, history, path=["response"])
    ...
    async def test_raw_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.h3geo.history.with_raw_response.count(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    async def test_streaming_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.h3geo.history.with_streaming_response.count(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_query(self, async_client: AsyncUnifieddatalibrary) -> None:
        history = await async_client.h3geo.history.query(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
        assert_matches_type(HistoryQueryResponse, history, path=["response"])
    ...
    async def test_raw_response_query(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.h3geo.history.with_raw_response.query(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    async def test_streaming_response_query(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.h3geo.history.with_streaming_response.query(
            start_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

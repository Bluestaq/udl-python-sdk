...
class TestLogisticssupport:
    ...
    def test_method_list(self, client: Unifieddatalibrary) -> None:
        ...
        assert_matches_type(SyncOffsetPage[LogisticssupportListResponse], logisticssupport, path=["response"])
    ...
    def test_streaming_response_list(self, client: Unifieddatalibrary) -> None:
        with client.logisticssupport.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_count(self, client: Unifieddatalibrary) -> None:
        response = client.logisticssupport.with_raw_response.count()
    ...
    def test_streaming_response_count(self, client: Unifieddatalibrary) -> None:
        with client.logisticssupport.with_streaming_response.count() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_queryhelp(self, client: Unifieddatalibrary) -> None:
        logisticssupport = client.logisticssupport.queryhelp()
        assert logisticssupport is None

    @parametrize
    def test_raw_response_queryhelp(self, client: Unifieddatalibrary) -> None:
        response = client.logisticssupport.with_raw_response.queryhelp()
    ...
    def test_streaming_response_queryhelp(self, client: Unifieddatalibrary) -> None:
        with client.logisticssupport.with_streaming_response.queryhelp() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_tuple(self, client: Unifieddatalibrary) -> None:
        response = client.logisticssupport.with_raw_response.tuple(
            columns="columns",
        )
    ...
    def test_streaming_response_tuple(self, client: Unifieddatalibrary) -> None:
        with client.logisticssupport.with_streaming_response.tuple(
            columns="columns",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncLogisticssupport:
    ...
    async def test_method_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        ...
        assert_matches_type(AsyncOffsetPage[LogisticssupportListResponse], logisticssupport, path=["response"])
    ...
    async def test_streaming_response_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.logisticssupport.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.logisticssupport.with_raw_response.count()
    ...
    async def test_streaming_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.logisticssupport.with_streaming_response.count() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_queryhelp(self, async_client: AsyncUnifieddatalibrary) -> None:
        logisticssupport = await async_client.logisticssupport.queryhelp()
        assert logisticssupport is None

    @parametrize
    async def test_raw_response_queryhelp(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.logisticssupport.with_raw_response.queryhelp()
    ...
    async def test_streaming_response_queryhelp(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.logisticssupport.with_streaming_response.queryhelp() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_tuple(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.logisticssupport.with_raw_response.tuple(
            columns="columns",
        )
    ...
    async def test_streaming_response_tuple(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.logisticssupport.with_streaming_response.tuple(
            columns="columns",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

...
class TestHistory:
    ...
    def test_method_list(self, client: Unifieddatalibrary) -> None:
        ...
        assert_matches_type(SyncOffsetPage[OrbitdeterminationFull], history, path=["response"])
...
class TestAsyncHistory:
    ...
    async def test_method_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        ...
        assert_matches_type(AsyncOffsetPage[OrbitdeterminationFull], history, path=["response"])

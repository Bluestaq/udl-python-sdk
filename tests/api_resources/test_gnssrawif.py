...
class TestGnssrawif:
    ...
    def test_method_file_create(self, client: Unifieddatalibrary) -> None:
        gnssrawif = client.gnssrawif.file_create(
    ...
    def test_raw_response_file_create(self, client: Unifieddatalibrary) -> None:
        response = client.gnssrawif.with_raw_response.file_create(
            center_freq=[1227.6, 1575.4],
            classification_marking="U",
            data_mode="REAL",
            end_time=parse_datetime("2022-04-09T18:12:28.919768Z"),
    ...
    def test_streaming_response_file_create(self, client: Unifieddatalibrary) -> None:
        with client.gnssrawif.with_streaming_response.file_create(
            center_freq=[1227.6, 1575.4],
            classification_marking="U",
            data_mode="REAL",
            end_time=parse_datetime("2022-04-09T18:12:28.919768Z"),
...
class TestAsyncGnssrawif:
    ...
    async def test_method_file_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        gnssrawif = await async_client.gnssrawif.file_create(
            center_freq=[1227.6, 1575.4],
            classification_marking="U",
            data_mode="REAL",
            end_time=parse_datetime("2022-04-09T18:12:28.919768Z"),
    ...
    async def test_raw_response_file_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.gnssrawif.with_raw_response.file_create(
            center_freq=[1227.6, 1575.4],
            classification_marking="U",
            data_mode="REAL",
            end_time=parse_datetime("2022-04-09T18:12:28.919768Z"),
    ...
    async def test_streaming_response_file_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.gnssrawif.with_streaming_response.file_create(
            center_freq=[1227.6, 1575.4],
            classification_marking="U",
            data_mode="REAL",
            end_time=parse_datetime("2022-04-09T18:12:28.919768Z"),

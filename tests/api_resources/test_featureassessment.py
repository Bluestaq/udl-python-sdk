...
class TestFeatureassessment:
    ...
    def test_method_create(self, client: Unifieddatalibrary) -> None:
        featureassessment = client.featureassessment.create(
    ...
    def test_raw_response_create(self, client: Unifieddatalibrary) -> None:
        response = client.featureassessment.with_raw_response.create(
            classification_marking="U",
            data_mode="TEST",
            feature_ts=parse_datetime("2024-06-22T17:53:06.123Z"),
            feature_uo_m="MHz",
    ...
    def test_streaming_response_create(self, client: Unifieddatalibrary) -> None:
        with client.featureassessment.with_streaming_response.create(
            classification_marking="U",
            data_mode="TEST",
            feature_ts=parse_datetime("2024-06-22T17:53:06.123Z"),
            feature_uo_m="MHz",
    ...
    def test_raw_response_count(self, client: Unifieddatalibrary) -> None:
        response = client.featureassessment.with_raw_response.count(
            id_analytic_imagery="idAnalyticImagery",
        )
    ...
    def test_streaming_response_count(self, client: Unifieddatalibrary) -> None:
        with client.featureassessment.with_streaming_response.count(
            id_analytic_imagery="idAnalyticImagery",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_create_bulk(self, client: Unifieddatalibrary) -> None:
        featureassessment = client.featureassessment.create_bulk(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "TEST",
    ...
    def test_raw_response_create_bulk(self, client: Unifieddatalibrary) -> None:
        response = client.featureassessment.with_raw_response.create_bulk(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "TEST",
    ...
    def test_streaming_response_create_bulk(self, client: Unifieddatalibrary) -> None:
        with client.featureassessment.with_streaming_response.create_bulk(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "TEST",
    ...
    def test_streaming_response_query(self, client: Unifieddatalibrary) -> None:
        with client.featureassessment.with_streaming_response.query(
            id_analytic_imagery="idAnalyticImagery",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_query_help(self, client: Unifieddatalibrary) -> None:
        featureassessment = client.featureassessment.query_help()
        assert featureassessment is None

    @parametrize
    def test_raw_response_query_help(self, client: Unifieddatalibrary) -> None:
        response = client.featureassessment.with_raw_response.query_help()
    ...
    def test_streaming_response_query_help(self, client: Unifieddatalibrary) -> None:
        with client.featureassessment.with_streaming_response.query_help() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_tuple(self, client: Unifieddatalibrary) -> None:
        response = client.featureassessment.with_raw_response.tuple(
            columns="columns",
            id_analytic_imagery="idAnalyticImagery",
        )
    ...
    def test_streaming_response_tuple(self, client: Unifieddatalibrary) -> None:
        with client.featureassessment.with_streaming_response.tuple(
            columns="columns",
            id_analytic_imagery="idAnalyticImagery",
        ) as response:
            assert not response.is_closed
...
class TestAsyncFeatureassessment:
    ...
    async def test_method_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        featureassessment = await async_client.featureassessment.create(
            classification_marking="U",
            data_mode="TEST",
            feature_ts=parse_datetime("2024-06-22T17:53:06.123Z"),
            feature_uo_m="MHz",
    ...
    async def test_raw_response_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.featureassessment.with_raw_response.create(
            classification_marking="U",
            data_mode="TEST",
            feature_ts=parse_datetime("2024-06-22T17:53:06.123Z"),
            feature_uo_m="MHz",
    ...
    async def test_streaming_response_create(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.featureassessment.with_streaming_response.create(
            classification_marking="U",
            data_mode="TEST",
            feature_ts=parse_datetime("2024-06-22T17:53:06.123Z"),
            feature_uo_m="MHz",
    ...
    async def test_raw_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.featureassessment.with_raw_response.count(
            id_analytic_imagery="idAnalyticImagery",
        )
    ...
    async def test_streaming_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.featureassessment.with_streaming_response.count(
            id_analytic_imagery="idAnalyticImagery",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_create_bulk(self, async_client: AsyncUnifieddatalibrary) -> None:
        featureassessment = await async_client.featureassessment.create_bulk(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "TEST",
    ...
    async def test_raw_response_create_bulk(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.featureassessment.with_raw_response.create_bulk(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "TEST",
    ...
    async def test_streaming_response_create_bulk(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.featureassessment.with_streaming_response.create_bulk(
            body=[
                {
                    "classification_marking": "U",
                    "data_mode": "TEST",
    ...
    async def test_streaming_response_query(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.featureassessment.with_streaming_response.query(
            id_analytic_imagery="idAnalyticImagery",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_query_help(self, async_client: AsyncUnifieddatalibrary) -> None:
        featureassessment = await async_client.featureassessment.query_help()
        assert featureassessment is None

    @parametrize
    async def test_raw_response_query_help(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.featureassessment.with_raw_response.query_help()
    ...
    async def test_streaming_response_query_help(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.featureassessment.with_streaming_response.query_help() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_tuple(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.featureassessment.with_raw_response.tuple(
            columns="columns",
            id_analytic_imagery="idAnalyticImagery",
        )
    ...
    async def test_streaming_response_tuple(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.featureassessment.with_streaming_response.tuple(
            columns="columns",
            id_analytic_imagery="idAnalyticImagery",
        ) as response:
            assert not response.is_closed

...
class TestStatus:
    ...
    def test_method_get_by_entity_id(self, client: Unifieddatalibrary) -> None:
        status = client.status.get_by_entity_id(
            path_id_entity="idEntity",
            query_id_entity="idEntity",
        )
    ...
    def test_path_params_get_by_entity_id(self, client: Unifieddatalibrary) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `path_id_entity` but received ''"):
    ...
    def test_path_params_get_by_entity_type(self, client: Unifieddatalibrary) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `path_entity_type` but received ''"):

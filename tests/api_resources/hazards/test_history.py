...
from unifieddatalibrary.types.hazards import (
...
class TestHistory:
    ...
    def test_method_count(self, client: Unifieddatalibrary) -> None:
        history = client.hazards.history.count(
    ...
    def test_raw_response_count(self, client: Unifieddatalibrary) -> None:
        response = client.hazards.history.with_raw_response.count(
            detect_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_streaming_response_count(self, client: Unifieddatalibrary) -> None:
        with client.hazards.history.with_streaming_response.count(
            detect_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
    ...
    def test_method_query(self, client: Unifieddatalibrary) -> None:
        history = client.hazards.history.query(
            detect_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_raw_response_query(self, client: Unifieddatalibrary) -> None:
        response = client.hazards.history.with_raw_response.query(
            detect_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_streaming_response_query(self, client: Unifieddatalibrary) -> None:
        with client.hazards.history.with_streaming_response.query(
            detect_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncHistory:
    ...
    async def test_method_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        history = await async_client.hazards.history.count(
            detect_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
        assert_matches_type(str, history, path=["response"])
    ...
    async def test_raw_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.hazards.history.with_raw_response.count(
            detect_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    async def test_streaming_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.hazards.history.with_streaming_response.count(
            detect_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_query(self, async_client: AsyncUnifieddatalibrary) -> None:
        history = await async_client.hazards.history.query(
            detect_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
        assert_matches_type(HistoryQueryResponse, history, path=["response"])
    ...
    async def test_raw_response_query(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.hazards.history.with_raw_response.query(
            detect_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    async def test_streaming_response_query(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.hazards.history.with_streaming_response.query(
            detect_time=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

...
class TestRfemitterdetails:
    ...
    def test_method_list(self, client: Unifieddatalibrary) -> None:
        ...
        assert_matches_type(SyncOffsetPage[RfemitterdetailListResponse], rfemitterdetail, path=["response"])
...
class TestAsyncRfemitterdetails:
    ...
    async def test_method_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        ...
        assert_matches_type(AsyncOffsetPage[RfemitterdetailListResponse], rfemitterdetail, path=["response"])

...
from unifieddatalibrary.types.logisticssupport import (
    HistoryListResponse,
)
...
class TestHistory:
    ...
    def test_raw_response_list(self, client: Unifieddatalibrary) -> None:
        response = client.logisticssupport.history.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Unifieddatalibrary) -> None:
        with client.logisticssupport.history.with_streaming_response.list() as response:
    ...
    def test_raw_response_aodr(self, client: Unifieddatalibrary) -> None:
        response = client.logisticssupport.history.with_raw_response.aodr()
    ...
    def test_streaming_response_aodr(self, client: Unifieddatalibrary) -> None:
        with client.logisticssupport.history.with_streaming_response.aodr() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_count(self, client: Unifieddatalibrary) -> None:
        response = client.logisticssupport.history.with_raw_response.count()
    ...
    def test_streaming_response_count(self, client: Unifieddatalibrary) -> None:
        with client.logisticssupport.history.with_streaming_response.count() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncHistory:
    ...
    async def test_raw_response_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.logisticssupport.history.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.logisticssupport.history.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.logisticssupport.history.with_raw_response.aodr()
    ...
    async def test_streaming_response_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.logisticssupport.history.with_streaming_response.aodr() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.logisticssupport.history.with_raw_response.count()
    ...
    async def test_streaming_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.logisticssupport.history.with_streaming_response.count() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

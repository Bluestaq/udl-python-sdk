...
class TestGroundimagery:
    ...
    def test_method_list(self, client: Unifieddatalibrary) -> None:
        ...
        assert_matches_type(SyncOffsetPage[GroundimageryListResponse], groundimagery, path=["response"])
...
class TestAsyncGroundimagery:
    ...
    async def test_method_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        ...
        assert_matches_type(AsyncOffsetPage[GroundimageryListResponse], groundimagery, path=["response"])

...
class ElsetsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        line1: str | NotGiven = NOT_GIVEN,
        line2: str | NotGiven = NOT_GIVEN,
        ...
        sourced_data_types: List[str] | NotGiven = NOT_GIVEN,
        ...
        Args:
          ...
          id_on_orbit: Unique identifier of the satellite on-orbit object, if correlated. For the
          ...
          line1: Read only derived/generated line1 of a legacy TLE (two line element set) format,
              ignored on create/edit operations.

          line2: Read only derived/generated line2 of a legacy TLE (two line element set) format,
              ignored on create/edit operations.

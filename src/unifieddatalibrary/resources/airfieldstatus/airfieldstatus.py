...
from ...types import airfieldstatus_list_params, airfieldstatus_count_params, airfieldstatus_create_params
from .history import (
    HistoryResource,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    airfieldstatus_count_params.AirfieldstatusCountParams,
                ),
            ),
            cast_to=str,
        )

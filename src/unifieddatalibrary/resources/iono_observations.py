...
from ..types import iono_observation_create_params
...
class IonoObservationsResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        body: Iterable[iono_observation_create_params.Body],
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[iono_observation_create_params.Body]),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-ionoobs",
            body=await async_maybe_transform(body, Iterable[iono_observation_create_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,

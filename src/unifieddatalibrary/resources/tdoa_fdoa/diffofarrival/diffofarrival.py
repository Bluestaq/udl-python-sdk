...
class DiffofarrivalResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        source: str,
        id: str | Omit = omit,
        azimuth1: float | Omit = omit,
        azimuth2: float | Omit = omit,
        ...
        elevation1: float | Omit = omit,
        elevation2: float | Omit = omit,
        ...
        Args:
          ...
          azimuth1: Line of sight azimuth angle for sensor 1, in degrees and topocentric frame.
              Azimuth ranges from 0 to 360 degrees.

          azimuth2: Line of sight azimuth angle for sensor 2, in degrees and topocentric frame.
              Azimuth ranges from 0 to 360 degrees.

          bandwidth: Bandwidth of the signal, in hertz.

          collection_mode: Collection mode (e.g., DIRECTED_SEARCH, MANUAL, NEIGHBORHOOD_WATCH, SPOT_SEARCH,
              SURVEY, etc.).

          delta_range: Delta range, in kilometers. Delta range calculation convention is (sensor2 -
              sensor1).

          delta_range_rate: Delta range rate, in kilometers per second. Delta range rate calculation
              convention is (sensor2 - sensor1).

          delta_range_rate_unc: One sigma uncertainty in the delta range rate, in kilometers per second.

          delta_range_unc: One sigma uncertainty in delta range, in kilometers.

          descriptor: Optional source-provided and searchable metadata or descriptor of the data.

          elevation1: Line of sight elevation angle for sensor 1, in degrees and topocentric frame.
              Elevation ranges from -90 to 90 degrees.

          elevation2: Line of sight elevation angle for sensor 2, in degrees and topocentric frame.
              Elevation ranges from -90 to 90 degrees.

          fdoa: Frequency difference of arrival of the center frequency signal, in hertz. FDOA
          ...
          frequency: Center frequency of the collect, in hertz.
          ...
          sen2alt: Sensor 2 altitude at obTime (if mobile/onorbit), in kilometers. If null, can be
          ...
          senalt: Sensor altitude at obTime (if mobile/onorbit), in kilometers. If null, can be
              obtained from sensor info.
          ...
          tdoa_amb: The number of full signal cycles the time difference of arrival measurement

...
from ...types.closelyspacedobjects import history_aodr_params, history_list_params, history_count_params
from ...types.closelyspacedobjects.history_list_response import HistoryListResponse
...
class HistoryResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get_api_list(
            "/udl/closelyspacedobjects/history",
    ...
    def aodr(
        ...
        *,
        ...
        return self._get(
            "/udl/closelyspacedobjects/history/aodr",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
    ...
    def count(
        ...
        *,
        ...
        return self._get(
            "/udl/closelyspacedobjects/history/count",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,

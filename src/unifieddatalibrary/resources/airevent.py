...
from ..types import (
    airevent_tuple_params,
    airevent_create_params,
    airevent_update_params,
    airevent_create_bulk_params,
)
...
from ..types.airevent_get_response import AireventGetResponse
from ..types.airevent_list_response import AireventListResponse
from ..types.airevent_tuple_response import AireventTupleResponse

__all__ = ["AireventResource", "AsyncAireventResource"]


class AireventResource(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AireventResourceWithRawResponse:
        """
        ...
        """
        return AireventResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AireventResourceWithStreamingResponse:
        """
        ...
        """
        return AireventResourceWithStreamingResponse(self)
    ...
    def create(
        ...
        *,
        ...
        receivers: Iterable[airevent_create_params.Receiver] | NotGiven = NOT_GIVEN,
        remarks: Iterable[airevent_create_params.Remark] | NotGiven = NOT_GIVEN,
        ...
        tankers: Iterable[airevent_create_params.Tanker] | NotGiven = NOT_GIVEN,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                airevent_create_params.AireventCreateParams,
            ),
    ...
    def update(
        ...
        *,
        ...
        planned_dep_time: Union[str, datetime] | NotGiven = NOT_GIVEN,
        priority: str | NotGiven = NOT_GIVEN,
        receivers: Iterable[airevent_update_params.Receiver] | NotGiven = NOT_GIVEN,
        remarks: Iterable[airevent_update_params.Remark] | NotGiven = NOT_GIVEN,
        rev_track: bool | NotGiven = NOT_GIVEN,
        rzct: Union[str, datetime] | NotGiven = NOT_GIVEN,
        rz_point: str | NotGiven = NOT_GIVEN,
        rz_type: str | NotGiven = NOT_GIVEN,
        short_track: bool | NotGiven = NOT_GIVEN,
        status_code: str | NotGiven = NOT_GIVEN,
        tankers: Iterable[airevent_update_params.Tanker] | NotGiven = NOT_GIVEN,
        track_time: float | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        ...
        Args:
          ...
          id_2: Unique identifier of the record, auto-generated by the system if not provided on
              create operations.
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                airevent_update_params.AireventUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def create_bulk(
        self,
        *,
        body: Iterable[airevent_create_bulk_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[airevent_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"columns": columns}, airevent_tuple_params.AireventTupleParams),
            ),
            cast_to=AireventTupleResponse,
        )


class AsyncAireventResource(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncAireventResourceWithRawResponse:
        """
        This property can be used as a prefix for any HTTP method call to return
        the raw response object instead of the parsed content.
        ...
        For more information, see https://www.github.com/stainless-sdks/unifieddatalibrary-python#accessing-raw-response-data-eg-headers
        """
        return AsyncAireventResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncAireventResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/stainless-sdks/unifieddatalibrary-python#with_streaming_response
        """
        return AsyncAireventResourceWithStreamingResponse(self)
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/airevent/createBulk",
            body=await async_maybe_transform(body, Iterable[airevent_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"columns": columns}, airevent_tuple_params.AireventTupleParams),
            ),
            cast_to=AireventTupleResponse,
        )


class AireventResourceWithRawResponse:
    def __init__(self, airevent: AireventResource) -> None:
        self._airevent = airevent
...
class AsyncAireventResourceWithRawResponse:
    def __init__(self, airevent: AsyncAireventResource) -> None:
        self._airevent = airevent
...
class AireventResourceWithStreamingResponse:
    def __init__(self, airevent: AireventResource) -> None:
        self._airevent = airevent
...
class AsyncAireventResourceWithStreamingResponse:
    def __init__(self, airevent: AsyncAireventResource) -> None:
        self._airevent = airevent

...
class StarCatalogResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        all_wise_id: str | NotGiven = NOT_GIVEN,
        all_wisew1_mag: float | NotGiven = NOT_GIVEN,
        all_wisew1_mag_unc: float | NotGiven = NOT_GIVEN,
        all_wisew2_mag: float | NotGiven = NOT_GIVEN,
        all_wisew2_mag_unc: float | NotGiven = NOT_GIVEN,
        all_wisew3_mag: float | NotGiven = NOT_GIVEN,
        all_wisew3_mag_unc: float | NotGiven = NOT_GIVEN,
        all_wisew4_mag: float | NotGiven = NOT_GIVEN,
        all_wisew4_mag_unc: float | NotGiven = NOT_GIVEN,
        ...
        shift_fwhm1: float | NotGiven = NOT_GIVEN,
        shift_fwhm6: float | NotGiven = NOT_GIVEN,
        two_mass_id: str | NotGiven = NOT_GIVEN,
        var_flag: bool | NotGiven = NOT_GIVEN,
        variability: str | NotGiven = NOT_GIVEN,

...
from ...types import (
    ...
    globalatmosphericmodel_create_bulk_v2_params,
)
from .history import (
    HistoryResource,
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                globalatmosphericmodel_create_bulk_v2_params.GlobalatmosphericmodelCreateBulkV2Params,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class GlobalatmosphericmodelResourceWithRawResponse:
    def __init__(self, globalatmosphericmodel: GlobalatmosphericmodelResource) -> None:
        ...
        self.create_bulk_v2 = to_raw_response_wrapper(
            globalatmosphericmodel.create_bulk_v2,
        )

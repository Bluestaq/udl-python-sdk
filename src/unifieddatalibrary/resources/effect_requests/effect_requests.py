...
from ...types import (
    ...
    effect_request_history_count_params,
)
from .history import (
    HistoryResource,
...
from ...types.mission_ops.effect_request import EffectRequest
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"created_at": created_at}, effect_request_history_count_params.EffectRequestHistoryCountParams
                ),
            ),
            cast_to=str,
        )

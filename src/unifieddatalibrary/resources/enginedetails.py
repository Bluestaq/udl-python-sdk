...
class EnginedetailsResourceWithRawResponse:
    def __init__(self, enginedetails: EnginedetailsResource) -> None:
        self._enginedetails = enginedetails
...
class AsyncEnginedetailsResourceWithRawResponse:
    def __init__(self, enginedetails: AsyncEnginedetailsResource) -> None:
        self._enginedetails = enginedetails

    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          exp_duration: Image exposure duration in seconds.
          ...
          mag: Calibrated magnitude in units of magnitudes.

          mag_norm_range: Formula: mag - 5.0 \\** log_10(geo_range / 1000000.0).

          mag_unc: Uncertainty of calibrated magnitude in units of magnitudes.
          ...
          range: Line of sight range in km.

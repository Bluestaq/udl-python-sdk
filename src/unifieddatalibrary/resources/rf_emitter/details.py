...
class DetailsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          antennas: The set of antennas hosted on this RF Emitter.
          ...
          services: The set of software services running on this RF Emitter.
          ...
          ttps: The set of EA/TTP techniques that are supported by this RF Emitter.
    ...
    def update(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._put(
            path_template("/udl/rfemitterdetails/{path_id}", path_id=path_id),
            body=maybe_transform(
                {
                    "classification_marking": classification_marking,
                    "data_mode": data_mode,
    ...
    def delete(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._delete(
            path_template("/udl/rfemitterdetails/{id}", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,

...
from ...types.air_operations import aircraft_sorty_create_bulk_v2_params
...
class AircraftSortiesResource(SyncAPIResource):
    ...
    def create_bulk_v2(
        self,
        *,
        body: Iterable[aircraft_sorty_create_bulk_v2_params.Body],
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[aircraft_sorty_create_bulk_v2_params.Body]),
    ...
    async def create_bulk_v2(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-aircraftsortie",
            body=await async_maybe_transform(body, Iterable[aircraft_sorty_create_bulk_v2_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AircraftSortiesResourceWithRawResponse:
    def __init__(self, aircraft_sorties: AircraftSortiesResource) -> None:
        ...
        self.create_bulk_v2 = to_raw_response_wrapper(
            aircraft_sorties.create_bulk_v2,
        )

...
from ...types.air_operations import aircraft_sorty_create_params
...
class AircraftSortiesResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        body: Iterable[aircraft_sorty_create_params.Body],
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[aircraft_sorty_create_params.Body]),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-aircraftsortie",
            body=await async_maybe_transform(body, Iterable[aircraft_sorty_create_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,

...
from ...types.air_operations import crewpaper_create_params, crewpaper_unpublish_params
...
class CrewpapersResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            "/filedrop/crewpapers",
            body=maybe_transform(body, crewpaper_create_params.CrewpaperCreateParams),
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    crewpaper_create_params.CrewpaperCreateParams,
                ),
            ),
            cast_to=NoneType,
        )
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/crewpapers",
            body=await async_maybe_transform(body, crewpaper_create_params.CrewpaperCreateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,

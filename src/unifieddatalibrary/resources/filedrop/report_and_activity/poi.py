...
from ....types.filedrop.report_and_activity import poi_create_params
...
class PoiResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        body: Iterable[poi_create_params.Body],
        ...
        return self._post(
            "/filedrop/udl-poi",
            body=maybe_transform(body, Iterable[poi_create_params.Body]),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-poi",
            body=await async_maybe_transform(body, Iterable[poi_create_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,

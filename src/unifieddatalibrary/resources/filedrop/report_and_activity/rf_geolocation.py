...
from ....types.filedrop.report_and_activity import rf_geolocation_create_params
...
class RfGeolocationResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        body: Iterable[rf_geolocation_create_params.Body],
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[rf_geolocation_create_params.Body]),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-rfgeolocation",
            body=await async_maybe_transform(body, Iterable[rf_geolocation_create_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class RfGeolocationResourceWithRawResponse:
    def __init__(self, rf_geolocation: RfGeolocationResource) -> None:
        self._rf_geolocation = rf_geolocation

        self.create = to_raw_response_wrapper(
            rf_geolocation.create,
        )


class AsyncRfGeolocationResourceWithRawResponse:
    def __init__(self, rf_geolocation: AsyncRfGeolocationResource) -> None:
        self._rf_geolocation = rf_geolocation

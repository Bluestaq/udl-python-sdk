...
from ...types.filedrop import elset_create_params
...
class ElsetsResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        body: Iterable[elset_create_params.Body],
        ...
        return self._post(
            "/filedrop/udl-elset",
            body=maybe_transform(body, Iterable[elset_create_params.Body]),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-elset",
            body=await async_maybe_transform(body, Iterable[elset_create_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,

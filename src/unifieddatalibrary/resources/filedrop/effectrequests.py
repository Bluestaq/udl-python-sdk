...
from ...types.filedrop import effectrequest_create_params
...
class EffectrequestsResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        body: Iterable[effectrequest_create_params.Body],
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[effectrequest_create_params.Body]),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-effectrequest",
            body=await async_maybe_transform(body, Iterable[effectrequest_create_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class EffectrequestsResourceWithRawResponse:
    def __init__(self, effectrequests: EffectrequestsResource) -> None:
        self._effectrequests = effectrequests

        self.create = to_raw_response_wrapper(
            effectrequests.create,
        )


class AsyncEffectrequestsResourceWithRawResponse:
    def __init__(self, effectrequests: AsyncEffectrequestsResource) -> None:
        self._effectrequests = effectrequests

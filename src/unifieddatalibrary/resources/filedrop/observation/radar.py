...
from ....types.filedrop.observation import radar_create_params
...
class RadarResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        body: Iterable[radar_create_params.Body],
        ...
        return self._post(
            "/filedrop/udl-radar",
            body=maybe_transform(body, Iterable[radar_create_params.Body]),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-radar",
            body=await async_maybe_transform(body, Iterable[radar_create_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,

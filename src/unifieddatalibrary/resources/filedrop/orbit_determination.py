...
from ...types.filedrop import orbit_determination_create_params
...
class OrbitDeterminationResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        body: Iterable[orbit_determination_create_params.Body],
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[orbit_determination_create_params.Body]),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-orbitdetermination",
            body=await async_maybe_transform(body, Iterable[orbit_determination_create_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class OrbitDeterminationResourceWithRawResponse:
    def __init__(self, orbit_determination: OrbitDeterminationResource) -> None:
        self._orbit_determination = orbit_determination

        self.create = to_raw_response_wrapper(
            orbit_determination.create,
        )


class AsyncOrbitDeterminationResourceWithRawResponse:
    def __init__(self, orbit_determination: AsyncOrbitDeterminationResource) -> None:
        self._orbit_determination = orbit_determination

...
from ...types.filedrop import gnssobservation_create_params
...
class GnssobservationsResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        body: Iterable[gnssobservation_create_params.Body],
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[gnssobservation_create_params.Body]),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-gnssobset",
            body=await async_maybe_transform(body, Iterable[gnssobservation_create_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class GnssobservationsResourceWithRawResponse:
    def __init__(self, gnssobservations: GnssobservationsResource) -> None:
        self._gnssobservations = gnssobservations

        self.create = to_raw_response_wrapper(
            gnssobservations.create,
        )


class AsyncGnssobservationsResourceWithRawResponse:
    def __init__(self, gnssobservations: AsyncGnssobservationsResource) -> None:
        self._gnssobservations = gnssobservations

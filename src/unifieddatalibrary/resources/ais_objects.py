...
from ..types import ais_object_create_params
...
class AIsObjectsResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        body: Iterable[ais_object_create_params.Body],
        ...
        return self._post(
            "/filedrop/udl-ais",
            body=maybe_transform(body, Iterable[ais_object_create_params.Body]),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-ais",
            body=await async_maybe_transform(body, Iterable[ais_object_create_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,

...
from ..types import ecp_sdr_unvalidated_publish_params
...
class EcpSdrResource(SyncAPIResource):
    ...
    def unvalidated_publish(
        self,
        *,
        body: Iterable[ecp_sdr_unvalidated_publish_params.Body],
        ...
        return self._post(
            "/filedrop/udl-ecpsdr",
            body=maybe_transform(body, Iterable[ecp_sdr_unvalidated_publish_params.Body]),
    ...
    async def unvalidated_publish(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-ecpsdr",
            body=await async_maybe_transform(body, Iterable[ecp_sdr_unvalidated_publish_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class EcpSdrResourceWithRawResponse:
    def __init__(self, ecp_sdr: EcpSdrResource) -> None:
        self._ecp_sdr = ecp_sdr

        self.unvalidated_publish = to_raw_response_wrapper(
            ecp_sdr.unvalidated_publish,
        )


class AsyncEcpSdrResourceWithRawResponse:
    def __init__(self, ecp_sdr: AsyncEcpSdrResource) -> None:
        self._ecp_sdr = ecp_sdr

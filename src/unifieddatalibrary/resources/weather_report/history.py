...
from ...types.weather_report import history_aodr_params, history_list_params, history_count_params
...
class HistoryResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
    ...
    ) -> SyncOffsetPage[WeatherReportFull]:
        """
        ...
        return self._get_api_list(
            ...
            page=SyncOffsetPage[WeatherReportFull],
...
class AsyncHistoryResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> AsyncPaginator[WeatherReportFull, AsyncOffsetPage[WeatherReportFull]]:
        """
        Service operation to dynamically query historical data by a variety of query
        parameters not specified in this API documentation. See the queryhelp operation
        (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
        ...
        return self._get_api_list(
            "/udl/weatherreport/history",
            page=AsyncOffsetPage[WeatherReportFull],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,

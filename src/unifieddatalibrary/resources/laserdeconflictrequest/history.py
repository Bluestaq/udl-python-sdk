...
from ...types.laserdeconflictrequest import history_aodr_params, history_list_params, history_count_params
from ...types.laserdeconflictrequest.history_list_response import HistoryListResponse
...
class HistoryResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get_api_list(
            "/udl/laserdeconflictrequest/history",
    ...
    def aodr(
        ...
        *,
        ...
        return self._get(
            "/udl/laserdeconflictrequest/history/aodr",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
    ...
    def count(
        ...
        *,
        ...
        return self._get(
            "/udl/laserdeconflictrequest/history/count",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,

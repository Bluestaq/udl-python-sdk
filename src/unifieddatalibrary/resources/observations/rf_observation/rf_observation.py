...
class RfObservationResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        jam_bands: SequenceNotStr[str] | Omit = omit,
        jam_to_sig_ratios: Iterable[float] | Omit = omit,
        ...
        Args:
          ...
          jam_bands: Array of frequency bands experiencing jamming or intentional interference. This
              array must be the same length as jamToSigRatios.

          jam_to_sig_ratios: Array of jamming-to-signal power ratios at the receiver for the specified
            ...
            body=maybe_transform(
                {
                    ...
                    "jam_bands": jam_bands,
                    "jam_to_sig_ratios": jam_to_sig_ratios,
                    "max_psd": max_psd,
                    "min_psd": min_psd,
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            path_template("/udl/rfobservation/{id}", id=id),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,

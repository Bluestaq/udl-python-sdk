...
class PassiveRadarObservationResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          accel: The target Acceleration measurement, in kilometers per second squared, for this
              observation.

          accel_unc: The target Acceleration uncertainty measurement, in kilometers per second
          ...
          bistatic_range_accel: Bistatic range acceleration, in kilometers per second squared.
          ...
          bistatic_range_rate: Rate of change of the bistatic path, in kilometers per second.

          bistatic_range_rate_unc: One sigma uncertainty in rate of change of the bistatic path, in kilometers per
              second.
          ...
          orthogonal_rcs_unc: One sigma uncertainty in orthogonal polarization Radar Cross Section, in meters
              squared.
          ...
          rcs_unc: One sigma uncertainty in principal polarization Radar Cross Section, in meters
              squared.
          ...
          senx: Sensor x position, in kilometers, at obTime (if mobile/onorbit) in the specified
              senReferenceFrame. If senReferenceFrame is null, then J2000 should be assumed.

          seny: Sensor y position, in kilometers, at obTime (if mobile/onorbit) in the specified
              senReferenceFrame. If senReferenceFrame is null, then J2000 should be assumed.

          senz: Sensor z position, in kilometers, at obTime (if mobile/onorbit) in the specified
              senReferenceFrame. If senReferenceFrame is null, then J2000 should be assumed.
          ...
          xvel: X velocity of target, in kilometers per second, in J2000 coordinate frame.

          yvel: Y velocity of target, in kilometers per second, in J2000 coordinate frame.

          zvel: Z velocity of target, in kilometers per second, in J2000 coordinate frame.
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            path_template("/udl/passiveradarobservation/{id}", id=id),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,

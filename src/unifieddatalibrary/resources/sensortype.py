...
from ..types import sensortype_get_params, sensortype_list_params
...
from ..types.sensortype_get_response import SensortypeGetResponse
from ..types.sensortype_list_response import SensortypeListResponse
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    sensortype_list_params.SensortypeListParams,
                ),
            ),
            cast_to=SensortypeListResponse,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    sensortype_get_params.SensortypeGetParams,
                ),
            ),
...
class SensortypeResourceWithRawResponse:
    def __init__(self, sensortype: SensortypeResource) -> None:
        ...
        self.queryhelp = to_raw_response_wrapper(
            sensortype.queryhelp,
        )


class AsyncSensortypeResourceWithRawResponse:
    def __init__(self, sensortype: AsyncSensortypeResource) -> None:
        self._sensortype = sensortype

...
from ..types import (
    ...
    rfgeolocation_file_create_params,
)
...
class RfgeolocationResource(SyncAPIResource):
    ...
    def file_create(
        self,
        *,
        body: Iterable[rfgeolocation_file_create_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[rfgeolocation_file_create_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncRfgeolocationResource(AsyncAPIResource):
    ...
    async def file_create(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-rfgeolocation",
            body=await async_maybe_transform(body, Iterable[rfgeolocation_file_create_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,

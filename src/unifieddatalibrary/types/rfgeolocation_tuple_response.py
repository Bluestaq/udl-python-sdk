...
__all__ = ["RfgeolocationTupleResponse", "RfgeolocationTupleResponseItem"]


class RfgeolocationTupleResponseItem(BaseModel):
...
RfgeolocationTupleResponse: TypeAlias = List[RfgeolocationTupleResponseItem]

from .shared.onorbit import Onorbit

if PYDANTIC_V2:
    RfgeolocationTupleResponseItem.model_rebuild()
else:
    RfgeolocationTupleResponseItem.update_forward_refs()  # type: ignore

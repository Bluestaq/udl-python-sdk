...
__all__ = [
    ...
    "SolarArrayDetail",
    "SolarArrayDetailManufacturerOrg",
    "SolarArrayDetailManufacturerOrgOrganizationDetail",
]


class SolarArrayDetailManufacturerOrgOrganizationDetail(BaseModel):
...
class SolarArrayDetailManufacturerOrg(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    organization_details: Optional[List[SolarArrayDetailManufacturerOrgOrganizationDetail]] = FieldInfo(
...
class SolarArrayDetail(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    manufacturer_org: Optional[SolarArrayDetailManufacturerOrg] = FieldInfo(alias="manufacturerOrg", default=None)
...
class SolararrayGetResponse(BaseModel):
    ...
    solar_array_details: Optional[List[SolarArrayDetail]] = FieldInfo(alias="solarArrayDetails", default=None)
    """

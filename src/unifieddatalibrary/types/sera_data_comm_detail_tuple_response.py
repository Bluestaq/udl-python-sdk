...
__all__ = ["SeraDataCommDetailTupleResponse", "SeraDataCommDetailTupleResponseItem"]


class SeraDataCommDetailTupleResponseItem(BaseModel):
...
SeraDataCommDetailTupleResponse: TypeAlias = List[SeraDataCommDetailTupleResponseItem]

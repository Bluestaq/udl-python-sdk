...
if PYDANTIC_V2:
    SensorGetResponse.model_rebuild()
    Sensorcharacteristic.model_rebuild()
    SensorlimitsCollection.model_rebuild()
    SensorObservationType.model_rebuild()
    SensorStat.model_rebuild()
    SensorType.model_rebuild()
else:
    SensorGetResponse.update_forward_refs()  # type: ignore
    Sensorcharacteristic.update_forward_refs()  # type: ignore
    SensorlimitsCollection.update_forward_refs()  # type: ignore
    SensorObservationType.update_forward_refs()  # type: ignore
    SensorStat.update_forward_refs()  # type: ignore
    SensorType.update_forward_refs()  # type: ignore

...
if PYDANTIC_V2:
    SeradataspacecraftdetailGetResponse.model_rebuild()
    Scientific.model_rebuild()
    SeradataCommDetail.model_rebuild()
    SeradataEarlyWarning.model_rebuild()
    SeradataNavigation.model_rebuild()
    SeradataOpticalPayload.model_rebuild()
    SeradataRadarPayload.model_rebuild()
    SeradataSigIntPayload.model_rebuild()
else:
    SeradataspacecraftdetailGetResponse.update_forward_refs()  # type: ignore
    Scientific.update_forward_refs()  # type: ignore
    SeradataCommDetail.update_forward_refs()  # type: ignore
    SeradataEarlyWarning.update_forward_refs()  # type: ignore
    SeradataNavigation.update_forward_refs()  # type: ignore
    SeradataOpticalPayload.update_forward_refs()  # type: ignore
    SeradataRadarPayload.update_forward_refs()  # type: ignore
    SeradataSigIntPayload.update_forward_refs()  # type: ignore

...
__all__ = ["DeconflictsetGetResponse", "DeconflictWindow"]


class DeconflictWindow(BaseModel):
...
class DeconflictsetGetResponse(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    deconflict_windows: Optional[List[DeconflictWindow]] = FieldInfo(alias="deconflictWindows", default=None)

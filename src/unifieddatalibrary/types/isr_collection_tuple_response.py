...
__all__ = [
    ...
    "IsrCollectionTupleResponseItem",
    "IsrCollectionTupleResponseItemTasking",
    "IsrCollectionTupleResponseItemTaskingCollectionPeriods",
    "IsrCollectionTupleResponseItemTaskingCollectionPeriodsActual",
    "IsrCollectionTupleResponseItemTaskingCollectionPeriodsPlanned",
    "IsrCollectionTupleResponseItemTaskingCollectionPeriodsPlannedAdditional",
    "IsrCollectionTupleResponseItemTransit",
]


class IsrCollectionTupleResponseItemTaskingCollectionPeriodsActual(BaseModel):
...
class IsrCollectionTupleResponseItemTaskingCollectionPeriodsPlannedAdditional(BaseModel):
    id: Optional[str] = None
...
class IsrCollectionTupleResponseItemTaskingCollectionPeriodsPlanned(BaseModel):
    additional: Optional[List[IsrCollectionTupleResponseItemTaskingCollectionPeriodsPlannedAdditional]] = None
...
class IsrCollectionTupleResponseItemTaskingCollectionPeriods(BaseModel):
    actual: Optional[List[IsrCollectionTupleResponseItemTaskingCollectionPeriodsActual]] = None
    """Actual start and stop for the collection."""

    planned: Optional[IsrCollectionTupleResponseItemTaskingCollectionPeriodsPlanned] = None


class IsrCollectionTupleResponseItemTasking(BaseModel):
    id: Optional[str] = None
    """Tasking Unique Identifier."""

    collection_periods: Optional[IsrCollectionTupleResponseItemTaskingCollectionPeriods] = FieldInfo(
...
class IsrCollectionTupleResponseItemTransit(BaseModel):
    id: Optional[str] = None
...
class IsrCollectionTupleResponseItem(BaseModel):
    ...
    taskings: Optional[List[IsrCollectionTupleResponseItemTasking]] = None
    """Individual taskings to complete the mission."""

    transit: Optional[List[IsrCollectionTupleResponseItemTransit]] = None
...
IsrCollectionTupleResponse: TypeAlias = List[IsrCollectionTupleResponseItem]

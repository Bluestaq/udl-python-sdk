...
__all__ = [
    ...
    "RfEmitterDetail",
    "RfEmitterDetailAmplifier",
    "RfEmitterDetailAntenna",
    "RfEmitterDetailAntennaFeed",
    "RfEmitterDetailAntennaReceiverChannel",
    "RfEmitterDetailAntennaTransmitChannel",
    "RfEmitterDetailPowerOffset",
    "RfEmitterDetailService",
    "RfEmitterDetailTtp",
    "RfEmitterDetailTtpTechniqueDefinition",
    "RfEmitterDetailTtpTechniqueDefinitionParamDefinition",
]


class RfEmitterDetailAmplifier(BaseModel):
...
class RfEmitterDetailAntennaFeed(BaseModel):
...
class RfEmitterDetailAntennaReceiverChannel(BaseModel):
...
class RfEmitterDetailAntennaTransmitChannel(BaseModel):
...
class RfEmitterDetailAntenna(BaseModel):
    ...
    feeds: Optional[List[RfEmitterDetailAntennaFeed]] = None
    ...
    receiver_channels: Optional[List[RfEmitterDetailAntennaReceiverChannel]] = FieldInfo(
        alias="receiverChannels", default=None
    )
    """The set of receiver channels for this antenna."""

    transmit_channels: Optional[List[RfEmitterDetailAntennaTransmitChannel]] = FieldInfo(
        alias="transmitChannels", default=None
    )
    """The set of transmit channels for this antenna."""


class RfEmitterDetailPowerOffset(BaseModel):
...
class RfEmitterDetailService(BaseModel):
...
class RfEmitterDetailTtpTechniqueDefinitionParamDefinition(BaseModel):
    """
...
class RfEmitterDetailTtp(BaseModel):
    ...
    technique_definitions: Optional[List[RfEmitterDetailTtpTechniqueDefinition]] = FieldInfo(
...
class RfEmitterDetail(BaseModel):
    ...
    amplifier: Optional[RfEmitterDetailAmplifier] = None
    """An RF Amplifier associated with an RF Emitter Details."""

    antennas: Optional[List[RfEmitterDetailAntenna]] = None
    ...
    power_offsets: Optional[List[RfEmitterDetailPowerOffset]] = FieldInfo(alias="powerOffsets", default=None)
    """
    ...
    services: Optional[List[RfEmitterDetailService]] = None
    ...
    ttps: Optional[List[RfEmitterDetailTtp]] = None
...
class RfEmitterGetResponse(BaseModel):
    ...
    such as sensors, on-orbit objects, RF Emitters, spacecraft buses, etc. An entity
    can have an operating unit, a location (if terrestrial), and statuses.
    """

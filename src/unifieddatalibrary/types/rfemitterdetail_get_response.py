...
__all__ = [
    ...
    "ManufacturerOrg",
    "ManufacturerOrgOrganizationDetail",
    "ProductionFacilityLocation",
]


class ManufacturerOrgOrganizationDetail(BaseModel):
...
class ManufacturerOrg(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    organization_details: Optional[List[ManufacturerOrgOrganizationDetail]] = FieldInfo(
...
class ProductionFacilityLocation(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
...
class RfemitterdetailGetResponse(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    manufacturer_org: Optional[ManufacturerOrg] = FieldInfo(alias="manufacturerOrg", default=None)
    ...
    production_facility_location: Optional[ProductionFacilityLocation] = FieldInfo(

...
__all__ = [
    ...
    "LaunchvehicleTupleResponseItemLaunchVehicleDetailManufacturerOrg",
    "LaunchvehicleTupleResponseItemLaunchVehicleDetailManufacturerOrgOrganizationDetail",
    "LaunchvehicleTupleResponseItemStage",
]


class LaunchvehicleTupleResponseItemLaunchVehicleDetailManufacturerOrgOrganizationDetail(BaseModel):
...
class LaunchvehicleTupleResponseItemLaunchVehicleDetailManufacturerOrg(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    organization_details: Optional[
        List[LaunchvehicleTupleResponseItemLaunchVehicleDetailManufacturerOrgOrganizationDetail]
...
class LaunchvehicleTupleResponseItemLaunchVehicleDetail(BaseModel):
    ...
    manufacturer_org: Optional[LaunchvehicleTupleResponseItemLaunchVehicleDetailManufacturerOrg] = FieldInfo(

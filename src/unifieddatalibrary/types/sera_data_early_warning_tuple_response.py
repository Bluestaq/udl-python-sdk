...
__all__ = ["SeraDataEarlyWarningTupleResponse", "SeraDataEarlyWarningTupleResponseItem"]


class SeraDataEarlyWarningTupleResponseItem(BaseModel):
...
SeraDataEarlyWarningTupleResponse: TypeAlias = List[SeraDataEarlyWarningTupleResponseItem]

...
class AviationRiskManagementCreateParams(TypedDict, total=False):
    ...
    aviation_risk_management_worksheet_record: Annotated[
        Iterable[AviationRiskManagementWorksheetRecord], PropertyInfo(alias="aviationRiskManagementWorksheetRecord")
    ]
...
class AviationRiskManagementWorksheetRecordAviationRiskManagementWorksheetScore(TypedDict, total=False):
    ...
    aviation_risk_management_sortie: Annotated[
        Iterable[AviationRiskManagementWorksheetRecordAviationRiskManagementWorksheetScoreAviationRiskManagementSortie],
...
class AviationRiskManagementWorksheetRecord(TypedDict, total=False):
    ...
    aviation_risk_management_worksheet_score: Annotated[
        Iterable[AviationRiskManagementWorksheetRecordAviationRiskManagementWorksheetScore],

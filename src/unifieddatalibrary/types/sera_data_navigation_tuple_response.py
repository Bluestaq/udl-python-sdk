...
__all__ = ["SeraDataNavigationTupleResponse", "SeraDataNavigationTupleResponseItem"]


class SeraDataNavigationTupleResponseItem(BaseModel):
...
SeraDataNavigationTupleResponse: TypeAlias = List[SeraDataNavigationTupleResponseItem]

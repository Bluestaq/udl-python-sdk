...
__all__ = ["FeatureAssessmentTupleResponse", "FeatureAssessmentTupleResponseItem"]


class FeatureAssessmentTupleResponseItem(BaseModel):
...
FeatureAssessmentTupleResponse: TypeAlias = List[FeatureAssessmentTupleResponseItem]

...
class Sensorcharacteristic(TypedDict, total=False):
    ...
    acceptable_sat_id_formats: Annotated[SequenceNotStr[str], PropertyInfo(alias="acceptableSatIdFormats")]
    """
    ...
    data_formats: Annotated[SequenceNotStr[str], PropertyInfo(alias="dataFormats")]
    ...
    max_data_transmission_rate: Annotated[float, PropertyInfo(alias="maxDataTransmissionRate")]
    ...
    max_num_tracks: Annotated[int, PropertyInfo(alias="maxNumTracks")]
    ...
    num_search_patterns: Annotated[int, PropertyInfo(alias="numSearchPatterns")]
    ...
    obs_per_track: Annotated[int, PropertyInfo(alias="obsPerTrack")]
    """Standard number of observations within a track."""

    obs_spacing: Annotated[float, PropertyInfo(alias="obsSpacing")]
    ...
    search_pattern_points: Annotated[Iterable[float], PropertyInfo(alias="searchPatternPoints")]
    """
    ...
    settle_time: Annotated[float, PropertyInfo(alias="settleTime")]
    """
    ...
    tasking_channels: Annotated[SequenceNotStr[str], PropertyInfo(alias="taskingChannels")]

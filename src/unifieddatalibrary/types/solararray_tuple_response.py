...
__all__ = [
    ...
    "SolararrayTupleResponseItem",
    "SolararrayTupleResponseItemSolarArrayDetail",
    "SolararrayTupleResponseItemSolarArrayDetailManufacturerOrg",
    "SolararrayTupleResponseItemSolarArrayDetailManufacturerOrgOrganizationDetail",
]


class SolararrayTupleResponseItemSolarArrayDetailManufacturerOrgOrganizationDetail(BaseModel):
...
class SolararrayTupleResponseItemSolarArrayDetailManufacturerOrg(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    organization_details: Optional[
        List[SolararrayTupleResponseItemSolarArrayDetailManufacturerOrgOrganizationDetail]
...
class SolararrayTupleResponseItemSolarArrayDetail(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    manufacturer_org: Optional[SolararrayTupleResponseItemSolarArrayDetailManufacturerOrg] = FieldInfo(
...
class SolararrayTupleResponseItem(BaseModel):
    ...
    solar_array_details: Optional[List[SolararrayTupleResponseItemSolarArrayDetail]] = FieldInfo(

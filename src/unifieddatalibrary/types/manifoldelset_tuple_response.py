...
__all__ = ["ManifoldelsetTupleResponse", "ManifoldelsetTupleResponseItem"]


class ManifoldelsetTupleResponseItem(BaseModel):
...
ManifoldelsetTupleResponse: TypeAlias = List[ManifoldelsetTupleResponseItem]

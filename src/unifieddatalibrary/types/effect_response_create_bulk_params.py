...
__all__ = ["EffectResponseCreateBulkParams", "Body", "BodyActionsList", "BodyActionsListActionMetric", "BodyCoaMetric"]


class EffectResponseCreateBulkParams(TypedDict, total=False):

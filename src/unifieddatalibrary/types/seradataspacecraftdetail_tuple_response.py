...
if PYDANTIC_V2:
    SeradataspacecraftdetailTupleResponseItem.model_rebuild()
    SeradataspacecraftdetailTupleResponseItemScientific.model_rebuild()
    SeradataspacecraftdetailTupleResponseItemSeradataCommDetail.model_rebuild()
    SeradataspacecraftdetailTupleResponseItemSeradataEarlyWarning.model_rebuild()
    SeradataspacecraftdetailTupleResponseItemSeradataNavigation.model_rebuild()
    SeradataspacecraftdetailTupleResponseItemSeradataOpticalPayload.model_rebuild()
    SeradataspacecraftdetailTupleResponseItemSeradataRadarPayload.model_rebuild()
    SeradataspacecraftdetailTupleResponseItemSeradataSigIntPayload.model_rebuild()
else:
    SeradataspacecraftdetailTupleResponseItem.update_forward_refs()  # type: ignore
    SeradataspacecraftdetailTupleResponseItemScientific.update_forward_refs()  # type: ignore
    SeradataspacecraftdetailTupleResponseItemSeradataCommDetail.update_forward_refs()  # type: ignore
    SeradataspacecraftdetailTupleResponseItemSeradataEarlyWarning.update_forward_refs()  # type: ignore
    SeradataspacecraftdetailTupleResponseItemSeradataNavigation.update_forward_refs()  # type: ignore
    SeradataspacecraftdetailTupleResponseItemSeradataOpticalPayload.update_forward_refs()  # type: ignore
    SeradataspacecraftdetailTupleResponseItemSeradataRadarPayload.update_forward_refs()  # type: ignore
    SeradataspacecraftdetailTupleResponseItemSeradataSigIntPayload.update_forward_refs()  # type: ignore

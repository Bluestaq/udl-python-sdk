...
from .onorbit.antenna_details_full import AntennaDetailsFull
...
class AntennaFull(BaseModel):
    ...
    antenna_details: Optional[List[AntennaDetailsFull]] = FieldInfo(alias="antennaDetails", default=None)
    """

...
__all__ = ["SeradataOpticalPayloadTupleResponse", "SeradataOpticalPayloadTupleResponseItem"]
...
SeradataOpticalPayloadTupleResponse: TypeAlias = List[SeradataOpticalPayloadTupleResponseItem]

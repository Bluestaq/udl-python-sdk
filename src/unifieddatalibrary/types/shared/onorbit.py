...
__all__ = [
    ...
    "Battery",
    "EntityCollection",
    "EntityCollectionLocation",
    "EntityCollectionOperatingUnit",
    "EntityCollectionOperatingUnitLocation",
    "EntityCollectionOperatingUnitOperatingUnitRemark",
    "EntityCollectionOperatingUnitOrganization",
    "EntityCollectionOperatingUnitOrganizationOrganizationDetail",
...
class EntityCollectionLocation(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
...
class EntityCollectionOperatingUnitLocation(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
...
class EntityCollectionOperatingUnitOrganizationOrganizationDetail(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
...
class EntityCollectionOperatingUnitOrganization(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    organization_details: Optional[List[EntityCollectionOperatingUnitOrganizationOrganizationDetail]] = FieldInfo(
...
class EntityCollectionOperatingUnit(BaseModel):
    ...
    location: Optional[EntityCollectionOperatingUnitLocation] = None
    """
    ...
    organization: Optional[EntityCollectionOperatingUnitOrganization] = None
...
class EntityCollection(BaseModel):
    ...
    location: Optional[EntityCollectionLocation] = None
    """
    Model representation of a location, which is a specific fixed point on the earth
    and is used to denote the locations of fixed sensors, operating units, etc.
    """

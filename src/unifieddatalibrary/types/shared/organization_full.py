...
from .organization_details_full import OrganizationDetailsFull

__all__ = ["OrganizationFull"]
...
class OrganizationFull(BaseModel):
    ...
    organization_details: Optional[List[OrganizationDetailsFull]] = FieldInfo(alias="organizationDetails", default=None)
    """

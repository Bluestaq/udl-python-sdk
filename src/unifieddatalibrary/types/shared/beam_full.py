...
class BeamFull(BaseModel):
    ...
    beam_contours: Optional[List[BeamcontourFull]] = FieldInfo(alias="beamContours", default=None)
    """Read-only collection of beamContours, ignored on create/update.

    These details must be created separately via the /udl/beamcontour operations.
    """

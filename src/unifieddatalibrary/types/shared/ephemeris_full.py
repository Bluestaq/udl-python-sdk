...
__all__ = ["EphemerisFull"]


class EphemerisFull(BaseModel):
    """
    ...
    Ephemeris Set covReferenceFrame.
    ...
    covariance matrix. The size of the covariance matrix is dynamic, depending on
    whether the covariance for position only or position & velocity.

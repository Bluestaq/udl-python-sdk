...
class NotificationFull(BaseModel):
    ...
    msg_body: str = FieldInfo(alias="msgBody")
    """The message body content as a text string, XML, JSON, etc.

    If JSON is used for the msgBody, it should be 'inline' with the notification
    message JSON (without quotation marks or escape characters). Size of the msg
    body cannot be over 1MB.
    """

    msg_type: str = FieldInfo(alias="msgType")

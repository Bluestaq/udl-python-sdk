...
__all__ = ["SiteTupleResponse", "SiteTupleResponseItem", "SiteTupleResponseItemSiteRemark"]
...
if PYDANTIC_V2:
    SiteTupleResponseItem.model_rebuild()
    SiteTupleResponseItemSiteRemark.model_rebuild()
else:
    SiteTupleResponseItem.update_forward_refs()  # type: ignore
    SiteTupleResponseItemSiteRemark.update_forward_refs()  # type: ignore

...
__all__ = ["OrganizationdetailFindBySourceResponse", "OrganizationdetailFindBySourceResponseItem"]


class OrganizationdetailFindBySourceResponseItem(BaseModel):
...
OrganizationdetailFindBySourceResponse: TypeAlias = List[OrganizationdetailFindBySourceResponseItem]

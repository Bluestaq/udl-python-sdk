...
class AircraftStatusUpdateParams(TypedDict, total=False):
    ...
    additional_sys: Annotated[List[str], PropertyInfo(alias="additionalSys")]
    """
    List of additional operational systems on this aircraft beyond what is normally
    available.
    """

    air_to_air_status: Annotated[str, PropertyInfo(alias="airToAirStatus")]
    """
    The status of the air-to-air weapon release system (OPERATIONAL,
    NON-OPERATIONAL, OFF).
    """

    air_to_ground_status: Annotated[str, PropertyInfo(alias="airToGroundStatus")]
    """
    ...
    unavailable_sys: Annotated[List[str], PropertyInfo(alias="unavailableSys")]

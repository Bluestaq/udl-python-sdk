...
class IonoObservationCreateParams(TypedDict, total=False):
...
class BodyPolarization(TypedDict, total=False):
    data: Iterable[Iterable[Iterable[Iterable[Iterable[Iterable[List[str]]]]]]]
...
class Body(TypedDict, total=False):
    ...
    """For phased arrays, a 2D array.

    1st dimension spans the dimension antenna_element (see phase or amplitude). 2nd
    dimension spans 3 (x, y, z) Cartesian coordinates.
    """

    antenna_element_position_coordinate_system: Annotated[
        str, PropertyInfo(alias="antennaElementPositionCoordinateSystem")
    ]
    """
    ...
    azimuth: BodyAzimuth
    """Multidimensional array of incoming azimuth at the receiver.

    Has the same dimensions as power. Antenna type, configuration, and method of
    determination to be documented in the azimuthNotes field.
    """
    ...
    """Multidimensional array of incoming elevation at the receiver.

    Has the same dimensions as power. Antenna type, configuration, and method of
    determination to be documented in the metadata notes field.
    """
    ...
    receive_sensor_type: Annotated[str, PropertyInfo(alias="receiveSensorType")]
    """Enums: Mobile, Static."""
    ...
    transmit_sensor_type: Annotated[str, PropertyInfo(alias="transmitSensorType")]
    """Enums: Mobile, Static."""

...
__all__ = ["RfgeolocationGetResponse"]


class RfgeolocationGetResponse(BaseModel):
...
if PYDANTIC_V2:
    RfgeolocationGetResponse.model_rebuild()
else:
    RfgeolocationGetResponse.update_forward_refs()  # type: ignore

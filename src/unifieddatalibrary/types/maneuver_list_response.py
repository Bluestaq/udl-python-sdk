...
from .elset_abridged import ElsetAbridged
from .state_vector_abridged import StateVectorAbridged

__all__ = ["ManeuverListResponse", "ManeuverListResponseItem"]
...
class ManeuverListResponseItem(BaseModel):
    ...
    post_event_elset: Optional[ElsetAbridged] = FieldInfo(alias="postEventElset", default=None)
    """
    ...
    post_event_state_vector: Optional[StateVectorAbridged] = FieldInfo(alias="postEventStateVector", default=None)
    """
    ...
    pre_event_elset: Optional[ElsetAbridged] = FieldInfo(alias="preEventElset", default=None)
    """
    An element set is a collection of Keplerian orbital elements describing an orbit
    of a particular satellite. The data is used along with an orbit propagator in
    order to predict the motion of a satellite. The element set, or elset for short,
    ...
    pre_event_state_vector: Optional[StateVectorAbridged] = FieldInfo(alias="preEventStateVector", default=None)
    """
    This service provides operations for querying and manipulation of state vectors
    for OnOrbit objects. State vectors are cartesian vectors of position (r) and
    velocity (v) that, together with their time (epoch) (t), uniquely determine the

...
__all__ = ["OrbittrackTupleResponse", "OrbittrackTupleResponseItem", "OrbittrackTupleResponseItemTrackSensor"]


class OrbittrackTupleResponseItemTrackSensor(BaseModel):
    az: float
...
class OrbittrackTupleResponseItem(BaseModel):
    ...
    track_sensors: Optional[List[OrbittrackTupleResponseItemTrackSensor]] = FieldInfo(
        alias="trackSensors", default=None
    )
...
OrbittrackTupleResponse: TypeAlias = List[OrbittrackTupleResponseItem]

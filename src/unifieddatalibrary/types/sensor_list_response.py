...
from .entity_abridged import EntityAbridged

__all__ = [
    "SensorListResponse",
    "SensorListResponseItem",
    "SensorListResponseItemSensorcharacteristic",
    "SensorListResponseItemSensorlimitsCollection",
    "SensorListResponseItemSensorObservationType",
    "SensorListResponseItemSensorStat",
    "SensorListResponseItemSensorType",
]


class SensorListResponseItemSensorcharacteristic(BaseModel):
...
class SensorListResponseItemSensorlimitsCollection(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
...
class SensorListResponseItemSensorObservationType(BaseModel):
    id: Optional[str] = None
    """Unique identifier of the record, auto-generated by the system."""
...
class SensorListResponseItemSensorStat(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
...
class SensorListResponseItemSensorType(BaseModel):
...
class SensorListResponseItem(BaseModel):
    ...
    entity: Optional[EntityAbridged] = None
    """
    ...
    sensorcharacteristics: Optional[List[SensorListResponseItemSensorcharacteristic]] = None
    """
    Collection of Sensorcharacteristics which define characteristics and
    capabilities of a sensor.
    """

    sensorlimits_collection: Optional[List[SensorListResponseItemSensorlimitsCollection]] = FieldInfo(
    ...
    sensor_observation_type: Optional[SensorListResponseItemSensorObservationType] = FieldInfo(
        alias="sensorObservationType", default=None
    )

    sensor_stats: Optional[List[SensorListResponseItemSensorStat]] = FieldInfo(alias="sensorStats", default=None)
    """Collection of SensorStats which contain statistics of a sensor."""

    sensor_type: Optional[SensorListResponseItemSensorType] = FieldInfo(alias="sensorType", default=None)

    short_name: Optional[str] = FieldInfo(alias="shortName", default=None)
    """Optional short name for the sensor."""


SensorListResponse: TypeAlias = List[SensorListResponseItem]

...
class TrackListResponse(BaseModel):
    ...
    e_nu_ground_vel: Optional[List[float]] = FieldInfo(alias="eNUGroundVel", default=None)
    ...
    obj_description: Optional[str] = FieldInfo(alias="objDescription", default=None)
    """
    ...
    vert_unc: Optional[float] = FieldInfo(alias="vertUnc", default=None)
    """
    ...
    wander_ang: Optional[float] = FieldInfo(alias="wanderAng", default=None)
    """

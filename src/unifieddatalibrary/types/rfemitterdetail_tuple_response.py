...
__all__ = [
    ...
    "RfemitterdetailTupleResponseItem",
    "RfemitterdetailTupleResponseItemManufacturerOrg",
    "RfemitterdetailTupleResponseItemManufacturerOrgOrganizationDetail",
    "RfemitterdetailTupleResponseItemProductionFacilityLocation",
]


class RfemitterdetailTupleResponseItemManufacturerOrgOrganizationDetail(BaseModel):
...
class RfemitterdetailTupleResponseItemManufacturerOrg(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    organization_details: Optional[List[RfemitterdetailTupleResponseItemManufacturerOrgOrganizationDetail]] = FieldInfo(
...
class RfemitterdetailTupleResponseItemProductionFacilityLocation(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
...
class RfemitterdetailTupleResponseItem(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    manufacturer_org: Optional[RfemitterdetailTupleResponseItemManufacturerOrg] = FieldInfo(
    ...
    production_facility_location: Optional[RfemitterdetailTupleResponseItemProductionFacilityLocation] = FieldInfo(
...
RfemitterdetailTupleResponse: TypeAlias = List[RfemitterdetailTupleResponseItem]

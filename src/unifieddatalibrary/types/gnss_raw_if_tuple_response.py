...
__all__ = ["GnssRawIfTupleResponse", "GnssRawIfTupleResponseItem"]


class GnssRawIfTupleResponseItem(BaseModel):
...
GnssRawIfTupleResponse: TypeAlias = List[GnssRawIfTupleResponseItem]

...
__all__ = [
    ...
    "HistoryListResponseItemActionsList",
    "HistoryListResponseItemActionsListActionMetric",
    "HistoryListResponseItemCoaMetric",
]


class HistoryListResponseItemActionsListActionMetric(BaseModel):
...
class HistoryListResponseItemActionsList(BaseModel):
    ...
    action_metrics: Optional[List[HistoryListResponseItemActionsListActionMetric]] = FieldInfo(
...
class HistoryListResponseItemCoaMetric(BaseModel):
    domain_value: Optional[float] = FieldInfo(alias="domainValue", default=None)
    """The metric score specific to its domain."""
...
class HistoryListResponseItem(BaseModel):
    ...
    actions_list: Optional[List[HistoryListResponseItemActionsList]] = FieldInfo(alias="actionsList", default=None)
    ...
    coa_metrics: Optional[List[HistoryListResponseItemCoaMetric]] = FieldInfo(alias="coaMetrics", default=None)

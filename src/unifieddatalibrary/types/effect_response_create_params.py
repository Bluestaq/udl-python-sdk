...
__all__ = ["EffectResponseCreateParams", "ActionsList", "ActionsListActionMetric", "CoaMetric"]
...
class EffectResponseCreateParams(TypedDict, total=False):
    ...
    actions_list: Annotated[Iterable[ActionsList], PropertyInfo(alias="actionsList")]
    ...
    coa_metrics: Annotated[Iterable[CoaMetric], PropertyInfo(alias="coaMetrics")]
...
class ActionsListActionMetric(TypedDict, total=False):
...
class ActionsList(TypedDict, total=False):
    ...
    action_metrics: Annotated[Iterable[ActionsListActionMetric], PropertyInfo(alias="actionMetrics")]
...
class CoaMetric(TypedDict, total=False):
    domain_value: Annotated[float, PropertyInfo(alias="domainValue")]
    """The metric score specific to its domain."""

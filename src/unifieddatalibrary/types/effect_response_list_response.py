...
__all__ = [
    ...
    "EffectResponseListResponseItem",
    "EffectResponseListResponseItemActionsList",
    "EffectResponseListResponseItemActionsListActionMetric",
    "EffectResponseListResponseItemCoaMetric",
]


class EffectResponseListResponseItemActionsListActionMetric(BaseModel):
...
class EffectResponseListResponseItemActionsList(BaseModel):
    ...
    action_metrics: Optional[List[EffectResponseListResponseItemActionsListActionMetric]] = FieldInfo(
        alias="actionMetrics", default=None
    )
...
class EffectResponseListResponseItemCoaMetric(BaseModel):
    domain_value: Optional[float] = FieldInfo(alias="domainValue", default=None)
    """The metric score specific to its domain."""
...
class EffectResponseListResponseItem(BaseModel):
    ...
    actions_list: Optional[List[EffectResponseListResponseItemActionsList]] = FieldInfo(
        alias="actionsList", default=None
    )
    ...
    coa_metrics: Optional[List[EffectResponseListResponseItemCoaMetric]] = FieldInfo(alias="coaMetrics", default=None)
...
EffectResponseListResponse: TypeAlias = List[EffectResponseListResponseItem]

...
__all__ = ["UdlSigactTextCreateParams", "RelatedDoc", "RelatedDocDataSourceRef"]


class UdlSigactTextCreateParams(TypedDict, total=False):
    ...
    related_docs: Annotated[Iterable[RelatedDoc], PropertyInfo(alias="relatedDocs")]
...
class RelatedDocDataSourceRef(TypedDict, total=False):
...
class RelatedDoc(TypedDict, total=False):
    data_source_refs: Annotated[Iterable[RelatedDocDataSourceRef], PropertyInfo(alias="dataSourceRefs")]

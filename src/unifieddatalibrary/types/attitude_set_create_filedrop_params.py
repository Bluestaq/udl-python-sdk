...
__all__ = ["AttitudeSetCreateFiledropParams", "AttitudeList"]


class AttitudeSetCreateFiledropParams(TypedDict, total=False):
    ...
    as_ref: Annotated[List[str], PropertyInfo(alias="asRef")]

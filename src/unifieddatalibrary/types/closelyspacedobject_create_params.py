...
__all__ = ["CloselyspacedobjectCreateParams", "CsoDetail"]


class CloselyspacedobjectCreateParams(TypedDict, total=False):
    ...
    cso_details: Annotated[Iterable[CsoDetail], PropertyInfo(alias="csoDetails")]
    """

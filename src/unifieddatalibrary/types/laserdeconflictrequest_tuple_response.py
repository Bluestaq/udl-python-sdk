...
__all__ = [
    ...
    "LaserdeconflictrequestTupleResponseItem",
    "LaserdeconflictrequestTupleResponseItemLaserDeconflictTarget",
]


class LaserdeconflictrequestTupleResponseItemLaserDeconflictTarget(BaseModel):
...
class LaserdeconflictrequestTupleResponseItem(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    laser_deconflict_targets: Optional[List[LaserdeconflictrequestTupleResponseItemLaserDeconflictTarget]] = FieldInfo(
...
LaserdeconflictrequestTupleResponse: TypeAlias = List[LaserdeconflictrequestTupleResponseItem]

...
__all__ = ["SeradataRadarPayloadTupleResponse", "SeradataRadarPayloadTupleResponseItem"]


class SeradataRadarPayloadTupleResponseItem(BaseModel):
...
SeradataRadarPayloadTupleResponse: TypeAlias = List[SeradataRadarPayloadTupleResponseItem]

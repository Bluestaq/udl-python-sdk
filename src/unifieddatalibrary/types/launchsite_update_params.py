...
__all__ = ["LaunchsiteUpdateParams"]


class LaunchsiteUpdateParams(TypedDict, total=False):
    ...
    alt_code: Annotated[str, PropertyInfo(alias="altCode")]
    ...
    short_code: Annotated[str, PropertyInfo(alias="shortCode")]

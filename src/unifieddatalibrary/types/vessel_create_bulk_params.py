...
__all__ = ["VesselCreateBulkParams", "Body", "BodyEntity", "BodyEntityLocation", "BodyEntityOnOrbit"]
...
class BodyEntityLocation(TypedDict, total=False):
...
class BodyEntityOnOrbit(TypedDict, total=False):
    classification_marking: Required[Annotated[str, PropertyInfo(alias="classificationMarking")]]
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
...
class BodyEntity(TypedDict, total=False):
    classification_marking: Required[Annotated[str, PropertyInfo(alias="classificationMarking")]]
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    location: BodyEntityLocation
    """
    Model representation of a location, which is a specific fixed point on the earth
    and is used to denote the locations of fixed sensors, operating units, etc.
    """

    on_orbit: Annotated[BodyEntityOnOrbit, PropertyInfo(alias="onOrbit")]

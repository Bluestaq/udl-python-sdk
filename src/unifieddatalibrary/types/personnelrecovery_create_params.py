...
class ExecutionInfoEscortVehicle(TypedDict, total=False):
    call_sign: Annotated[str, PropertyInfo(alias="callSign")]
...
class ExecutionInfoRecoveryVehicle(TypedDict, total=False):
    call_sign: Annotated[str, PropertyInfo(alias="callSign")]
    """The call sign of the recovery vehicle."""
...
class ObjectiveAreaInfo(TypedDict, total=False):
    enemy_data: Annotated[Iterable[ObjectiveAreaInfoEnemyData], PropertyInfo(alias="enemyData")]

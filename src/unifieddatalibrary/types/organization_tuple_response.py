...
__all__ = [
    ...
    "OrganizationTupleResponseItem",
    "OrganizationTupleResponseItemOrganizationDetail",
]


class OrganizationTupleResponseItemOrganizationDetail(BaseModel):
...
class OrganizationTupleResponseItem(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    organization_details: Optional[List[OrganizationTupleResponseItemOrganizationDetail]] = FieldInfo(
...
OrganizationTupleResponse: TypeAlias = List[OrganizationTupleResponseItem]

...
class LogisticssupportUpdateParams(TypedDict, total=False):
    ...
    logistics_discrepancy_infos: Annotated[
        Iterable[LogisticsDiscrepancyInfo], PropertyInfo(alias="logisticsDiscrepancyInfos")
    ]
    ...
    logistics_transportation_plans: Annotated[
        Iterable[LogisticsTransportationPlan], PropertyInfo(alias="logisticsTransportationPlans")
    ]
    """
...
class LogisticsSupportItemLogisticsPart(TypedDict, total=False):
    ...
    logistics_stocks: Annotated[
        Iterable[LogisticsSupportItemLogisticsPartLogisticsStock], PropertyInfo(alias="logisticsStocks")
    ]
...
class LogisticsSupportItem(TypedDict, total=False):
    ...
    logistics_specialties: Annotated[
        Iterable[LogisticsSupportItemLogisticsSpecialty], PropertyInfo(alias="logisticsSpecialties")
    ]
...
class LogisticsTransportationPlan(TypedDict, total=False):
    ...
    logistics_segments: Annotated[
        Iterable[LogisticsTransportationPlanLogisticsSegment], PropertyInfo(alias="logisticsSegments")
    ]

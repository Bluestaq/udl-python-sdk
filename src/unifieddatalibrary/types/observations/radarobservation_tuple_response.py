...
__all__ = ["RadarobservationTupleResponse", "RadarobservationTupleResponseItem"]


class RadarobservationTupleResponseItem(BaseModel):
...
RadarobservationTupleResponse: TypeAlias = List[RadarobservationTupleResponseItem]

...
class RfObservationCreateParams(TypedDict, total=False):
    ...
    jam_bands: Annotated[SequenceNotStr[str], PropertyInfo(alias="jamBands")]
    ...
    jam_to_sig_ratios: Annotated[Iterable[float], PropertyInfo(alias="jamToSigRatios")]
    """

...
__all__ = ["PassiveRadarObservationTupleResponse", "PassiveRadarObservationTupleResponseItem"]


class PassiveRadarObservationTupleResponseItem(BaseModel):
...
PassiveRadarObservationTupleResponse: TypeAlias = List[PassiveRadarObservationTupleResponseItem]

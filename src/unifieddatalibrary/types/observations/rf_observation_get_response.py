...
__all__ = ["RfObservationGetResponse"]


class RfObservationGetResponse(BaseModel):
    """
    ...
    jam_bands: Optional[List[str]] = FieldInfo(alias="jamBands", default=None)
    """Array of frequency bands experiencing jamming or intentional interference.

    This array must be the same length as jamToSigRatios.
    """

    jam_to_sig_ratios: Optional[List[float]] = FieldInfo(alias="jamToSigRatios", default=None)
    """

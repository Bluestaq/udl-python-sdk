...
class AirTaskingOrderCreateParams(TypedDict, total=False):
    ...
    ac_msn_tasking: Annotated[Iterable[AcMsnTasking], PropertyInfo(alias="acMsnTasking")]
    """
    ...
    gen_text: Annotated[Iterable[GenText], PropertyInfo(alias="genText")]
    """
    ...
    naval_flt_ops: Annotated[Iterable[NavalFltOp], PropertyInfo(alias="navalFltOps")]
...
class AcMsnTasking(TypedDict, total=False):
    ...
    ac_msn_loc_seg: Annotated[Iterable[AcMsnTaskingAcMsnLocSeg], PropertyInfo(alias="acMsnLocSeg")]
    """
    ...
    ind_ac_tasking: Annotated[Iterable[AcMsnTaskingIndAcTasking], PropertyInfo(alias="indACTasking")]
    """

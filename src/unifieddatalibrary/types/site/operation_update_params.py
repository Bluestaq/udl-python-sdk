...
class OperationUpdateParams(TypedDict, total=False):
    ...
    daily_operations: Annotated[Iterable[DailyOperation], PropertyInfo(alias="dailyOperations")]
    """
    ...
    maximum_on_grounds: Annotated[Iterable[MaximumOnGround], PropertyInfo(alias="maximumOnGrounds")]
    """
    ...
    operational_deviations: Annotated[Iterable[OperationalDeviation], PropertyInfo(alias="operationalDeviations")]
    """
    Collection providing relevant information in the event of deviations/exceptions
    to normal operations.
    """

    operational_plannings: Annotated[Iterable[OperationalPlanning], PropertyInfo(alias="operationalPlannings")]
...
class DailyOperationOperatingHour(TypedDict, total=False):
...
class DailyOperation(TypedDict, total=False):
    ...
    operating_hours: Annotated[Iterable[DailyOperationOperatingHour], PropertyInfo(alias="operatingHours")]
    """
...
class MaximumOnGround(TypedDict, total=False):
...
class OperationalDeviation(TypedDict, total=False):
...
class OperationalPlanning(TypedDict, total=False):
...
class Pathway(TypedDict, total=False):

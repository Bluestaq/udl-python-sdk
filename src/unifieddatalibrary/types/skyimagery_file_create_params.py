...
__all__ = ["SkyimageryFileCreateParams", "EoObservation", "EoObservationEoobservationDetails"]


class SkyimageryFileCreateParams(TypedDict, total=False):
    ...
    annotation_key: Annotated[str, PropertyInfo(alias="annotationKey")]
    """Reference to an annotation document associated with this image."""

    calibration_key: Annotated[str, PropertyInfo(alias="calibrationKey")]
    """Reference to a calibration document associated with this image."""

    description: str
    """Optional name/description associated with this image."""

    eo_observations: Annotated[Iterable[EoObservation], PropertyInfo(alias="eoObservations")]
    """Collection of linked EOObservations."""

    exp_end_time: Annotated[Union[str, datetime], PropertyInfo(alias="expEndTime", format="iso8601")]
    ...
    frame_fov_height: Annotated[float, PropertyInfo(alias="frameFOVHeight")]
    """Field Of View frame height, in degrees."""

    frame_fov_width: Annotated[float, PropertyInfo(alias="frameFOVWidth")]
    """Field Of View frame width, in degrees."""

    frame_height_pixels: Annotated[int, PropertyInfo(alias="frameHeightPixels")]
    """Frame height of the image, in number of pixels."""

    frame_width_pixels: Annotated[int, PropertyInfo(alias="frameWidthPixels")]
    ...
    id_soi_set: Annotated[str, PropertyInfo(alias="idSOISet")]
    """
    ...
    image_source_info: Annotated[str, PropertyInfo(alias="imageSourceInfo")]
    ...
    pixel_bit_depth: Annotated[int, PropertyInfo(alias="pixelBitDepth")]
    """Bit depth of the image, in number of pixels."""

    pixel_fov_height: Annotated[float, PropertyInfo(alias="pixelFOVHeight")]
    """Field Of View pixel height, in degrees."""

    pixel_fov_width: Annotated[float, PropertyInfo(alias="pixelFOVWidth")]
    ...
    sen_quat_dot: Annotated[Iterable[float], PropertyInfo(alias="senQuatDot")]
    """
    ...
    top_left_start_az: Annotated[float, PropertyInfo(alias="topLeftStartAz")]
    """The telescope pointing azimuth, in degrees, at the exposure start epoch."""

    top_left_start_el: Annotated[float, PropertyInfo(alias="topLeftStartEl")]
    """The telescope pointing elevation, in degrees, at the exposure start epoch."""

    top_left_stop_az: Annotated[float, PropertyInfo(alias="topLeftStopAz")]
    """The telescope pointing azimuth, in degrees, at the exposure stop epoch."""

    top_left_stop_el: Annotated[float, PropertyInfo(alias="topLeftStopEl")]
...
class EoObservationEoobservationDetails(TypedDict, total=False):
...
class EoObservation(TypedDict, total=False):
    classification_marking: Required[Annotated[str, PropertyInfo(alias="classificationMarking")]]
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    eoobservation_details: Annotated[EoObservationEoobservationDetails, PropertyInfo(alias="eoobservationDetails")]
    """

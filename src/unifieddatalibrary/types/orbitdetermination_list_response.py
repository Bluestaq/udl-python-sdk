...
__all__ = ["OrbitdeterminationListResponse", "OrbitdeterminationListResponseItem"]
...
class OrbitdeterminationListResponseItem(BaseModel):
    ...
    apriori_elset: Optional[ElsetAbridged] = FieldInfo(alias="aprioriElset", default=None)
    """
    ...
    apriori_state_vector: Optional[StateVectorAbridged] = FieldInfo(alias="aprioriStateVector", default=None)
    """

...
__all__ = ["LaunchsiteGetResponse", "LaunchSiteDetail", "LaunchSiteDetailLocation"]


class LaunchSiteDetailLocation(BaseModel):
...
class LaunchSiteDetail(BaseModel):
    ...
    location: Optional[LaunchSiteDetailLocation] = None
    """
...
class LaunchsiteGetResponse(BaseModel):
    ...
    launch_site_details: Optional[List[LaunchSiteDetail]] = FieldInfo(alias="launchSiteDetails", default=None)
    """

...
__all__ = ["SensorplanFull"]


class SensorplanFull(BaseModel):
    ...
    collect_requests: Optional[List["CollectRequestFull"]] = FieldInfo(alias="collectRequests", default=None)
...
if PYDANTIC_V2:
    SensorplanFull.model_rebuild()
else:
    SensorplanFull.update_forward_refs()  # type: ignore

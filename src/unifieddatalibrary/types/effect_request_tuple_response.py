...
__all__ = ["EffectRequestTupleResponse", "EffectRequestTupleResponseItem"]


class EffectRequestTupleResponseItem(BaseModel):
    ...
    BETWEEN, IMMEDIATE, NOEARLIERTHAN, NOLATERTHAN, etc.):
...
EffectRequestTupleResponse: TypeAlias = List[EffectRequestTupleResponseItem]

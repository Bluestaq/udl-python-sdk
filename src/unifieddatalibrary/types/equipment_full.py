...
from .equipment_remark_full import EquipmentRemarkFull

__all__ = ["EquipmentFull"]
...
class EquipmentFull(BaseModel):
    ...
    equipment_remarks: Optional[List[EquipmentRemarkFull]] = FieldInfo(alias="equipmentRemarks", default=None)

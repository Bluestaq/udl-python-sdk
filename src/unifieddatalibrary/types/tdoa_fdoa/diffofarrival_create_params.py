...
__all__ = ["DiffofarrivalCreateParams"]


class DiffofarrivalCreateParams(TypedDict, total=False):
    ...
    polarity_type: Annotated[str, PropertyInfo(alias="polarityType")]
    ...
    tdoa_amb: Annotated[int, PropertyInfo(alias="tdoaAmb")]
    """

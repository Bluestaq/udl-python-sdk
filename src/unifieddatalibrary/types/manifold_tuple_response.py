...
__all__ = ["ManifoldTupleResponse", "ManifoldTupleResponseItem"]


class ManifoldTupleResponseItem(BaseModel):
...
ManifoldTupleResponse: TypeAlias = List[ManifoldTupleResponseItem]

...
__all__ = ["EopCreateParams"]


class EopCreateParams(TypedDict, total=False):
    ...
    nutation_state: Annotated[str, PropertyInfo(alias="nutationState")]
    """
    ...
    polar_motion_state: Annotated[str, PropertyInfo(alias="polarMotionState")]
    """
    ...
    ut1_utc_state: Annotated[str, PropertyInfo(alias="ut1UTCState")]
    """

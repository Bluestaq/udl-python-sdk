...
__all__ = ["RfBandTypeTupleResponse", "RfBandTypeTupleResponseItem"]


class RfBandTypeTupleResponseItem(BaseModel):
    id: str
...
RfBandTypeTupleResponse: TypeAlias = List[RfBandTypeTupleResponseItem]

...
if PYDANTIC_V2:
    SensorTupleResponseItem.model_rebuild()
    SensorTupleResponseItemSensorcharacteristic.model_rebuild()
    SensorTupleResponseItemSensorlimitsCollection.model_rebuild()
    SensorTupleResponseItemSensorObservationType.model_rebuild()
    SensorTupleResponseItemSensorStat.model_rebuild()
    SensorTupleResponseItemSensorType.model_rebuild()
else:
    SensorTupleResponseItem.update_forward_refs()  # type: ignore
    SensorTupleResponseItemSensorcharacteristic.update_forward_refs()  # type: ignore
    SensorTupleResponseItemSensorlimitsCollection.update_forward_refs()  # type: ignore
    SensorTupleResponseItemSensorObservationType.update_forward_refs()  # type: ignore
    SensorTupleResponseItemSensorStat.update_forward_refs()  # type: ignore
    SensorTupleResponseItemSensorType.update_forward_refs()  # type: ignore

...
__all__ = [
    ...
    "OperatingunitTupleResponseItemLocation",
    "OperatingunitTupleResponseItemOperatingUnitRemark",
    "OperatingunitTupleResponseItemOrganization",
    "OperatingunitTupleResponseItemOrganizationOrganizationDetail",
]


class OperatingunitTupleResponseItemLocation(BaseModel):
...
class OperatingunitTupleResponseItemOrganizationOrganizationDetail(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
...
class OperatingunitTupleResponseItemOrganization(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    organization_details: Optional[List[OperatingunitTupleResponseItemOrganizationOrganizationDetail]] = FieldInfo(
...
class OperatingunitTupleResponseItem(BaseModel):
    ...
    location: Optional[OperatingunitTupleResponseItemLocation] = None
    """
    ...
    organization: Optional[OperatingunitTupleResponseItemOrganization] = None

...
__all__ = ["SurfaceTupleResponse", "SurfaceTupleResponseItem", "SurfaceTupleResponseItemSurfaceObstruction"]


class SurfaceTupleResponseItemSurfaceObstruction(BaseModel):
...
class SurfaceTupleResponseItem(BaseModel):
    ...
    surface_obstructions: Optional[List[SurfaceTupleResponseItemSurfaceObstruction]] = FieldInfo(
        alias="surfaceObstructions", default=None
    )
    """
...
SurfaceTupleResponse: TypeAlias = List[SurfaceTupleResponseItem]

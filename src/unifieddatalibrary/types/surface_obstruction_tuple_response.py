...
__all__ = ["SurfaceObstructionTupleResponse", "SurfaceObstructionTupleResponseItem"]


class SurfaceObstructionTupleResponseItem(BaseModel):
...
SurfaceObstructionTupleResponse: TypeAlias = List[SurfaceObstructionTupleResponseItem]

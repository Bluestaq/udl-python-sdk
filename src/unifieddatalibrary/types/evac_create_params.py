...
class EvacCreateParams(TypedDict, total=False):
    ...
    casualty_info: Annotated[Iterable[CasualtyInfo], PropertyInfo(alias="casualtyInfo")]
    ...
    enemy_data: Annotated[Iterable[EnemyData], PropertyInfo(alias="enemyData")]
...
class CasualtyInfoAllergy(TypedDict, total=False):
    comments: str
...
class CasualtyInfoCondition(TypedDict, total=False):
...
class CasualtyInfoEtiology(TypedDict, total=False):
    body_part: Annotated[str, PropertyInfo(alias="bodyPart")]
...
class CasualtyInfoHealthState(TypedDict, total=False):
...
class CasualtyInfoInjury(TypedDict, total=False):
    body_part: Annotated[str, PropertyInfo(alias="bodyPart")]
...
class CasualtyInfoMedication(TypedDict, total=False):
...
class CasualtyInfoTreatment(TypedDict, total=False):
    body_part: Annotated[str, PropertyInfo(alias="bodyPart")]
...
class CasualtyInfoVitalSignData(TypedDict, total=False):
    med_conf_factor: Annotated[int, PropertyInfo(alias="medConfFactor")]
    """Medical confidence factor."""
...
class CasualtyInfo(TypedDict, total=False):
    age: int
    """The patient age, in years."""

    allergy: Iterable[CasualtyInfoAllergy]
    """Allergy information."""
    ...
    condition: Iterable[CasualtyInfoCondition]
    ...
    etiology: Iterable[CasualtyInfoEtiology]
    ...
    health_state: Annotated[Iterable[CasualtyInfoHealthState], PropertyInfo(alias="healthState")]
    """Health state information."""

    injury: Iterable[CasualtyInfoInjury]
    """Injury specifics."""

    last4_ssn: Annotated[str, PropertyInfo(alias="last4SSN")]
    """Last 4 characters of the patient social security code, or equivalent."""

    medication: Iterable[CasualtyInfoMedication]
    ...
    treatment: Iterable[CasualtyInfoTreatment]
    """Treatment information."""

    vital_sign_data: Annotated[Iterable[CasualtyInfoVitalSignData], PropertyInfo(alias="vitalSignData")]

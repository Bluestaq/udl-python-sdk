...
__all__ = ["LocationTupleResponse", "LocationTupleResponseItem"]


class LocationTupleResponseItem(BaseModel):
...
LocationTupleResponse: TypeAlias = List[LocationTupleResponseItem]

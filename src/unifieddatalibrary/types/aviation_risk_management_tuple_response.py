...
__all__ = [
    ...
    "AviationRiskManagementTupleResponseItem",
    "AviationRiskManagementTupleResponseItemAviationRiskManagementWorksheetRecord",
    "AviationRiskManagementTupleResponseItemAviationRiskManagementWorksheetRecordAviationRiskManagementWorksheetScore",
    "AviationRiskManagementTupleResponseItemAviationRiskManagementWorksheetRecordAviationRiskManagementWorksheetScoreAviationRiskManagementSortie",
]
...
class AviationRiskManagementTupleResponseItem(BaseModel):
    ...
    aviation_risk_management_worksheet_record: Optional[
        List[AviationRiskManagementTupleResponseItemAviationRiskManagementWorksheetRecord]
    ] = FieldInfo(alias="aviationRiskManagementWorksheetRecord", default=None)
...
AviationRiskManagementTupleResponse: TypeAlias = List[AviationRiskManagementTupleResponseItem]

...
__all__ = ["SeradataSigintPayloadTupleResponse", "SeradataSigintPayloadTupleResponseItem"]


class SeradataSigintPayloadTupleResponseItem(BaseModel):
...
SeradataSigintPayloadTupleResponse: TypeAlias = List[SeradataSigintPayloadTupleResponseItem]

...
__all__ = ["GlobalAtmosphericModelQueryResponse", "GlobalAtmosphericModelQueryResponseItem"]


class GlobalAtmosphericModelQueryResponseItem(BaseModel):
...
GlobalAtmosphericModelQueryResponse: TypeAlias = List[GlobalAtmosphericModelQueryResponseItem]

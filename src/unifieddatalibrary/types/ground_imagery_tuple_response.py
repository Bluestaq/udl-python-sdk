...
__all__ = ["GroundImageryTupleResponse", "GroundImageryTupleResponseItem"]


class GroundImageryTupleResponseItem(BaseModel):
...
GroundImageryTupleResponse: TypeAlias = List[GroundImageryTupleResponseItem]

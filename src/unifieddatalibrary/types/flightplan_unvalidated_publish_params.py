...
__all__ = [
    ...
    "Body",
    "BodyAirRefuelEvent",
    "BodyFlightPlanMessage",
    "BodyFlightPlanPointGroup",
    "BodyFlightPlanPointGroupFlightPlanPoint",
    "BodyFlightPlanWaypoint",
]


class FlightplanUnvalidatedPublishParams(TypedDict, total=False):
...
class BodyFlightPlanPointGroup(TypedDict, total=False):
    ...
    flight_plan_points: Annotated[
        Iterable[BodyFlightPlanPointGroupFlightPlanPoint], PropertyInfo(alias="flightPlanPoints")
    ]
...
class Body(TypedDict, total=False):
    ...
    air_refuel_events: Annotated[Iterable[BodyAirRefuelEvent], PropertyInfo(alias="airRefuelEvents")]
    ...
    flight_plan_messages: Annotated[Iterable[BodyFlightPlanMessage], PropertyInfo(alias="flightPlanMessages")]
    """
    ...
    flight_plan_point_groups: Annotated[Iterable[BodyFlightPlanPointGroup], PropertyInfo(alias="flightPlanPointGroups")]
    ...
    flight_plan_waypoints: Annotated[Iterable[BodyFlightPlanWaypoint], PropertyInfo(alias="flightPlanWaypoints")]

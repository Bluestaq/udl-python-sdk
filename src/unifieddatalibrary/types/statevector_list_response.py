...
__all__ = ["StatevectorListResponse", "StatevectorListResponseItem"]


class StatevectorListResponseItem(BaseModel):
...
StatevectorListResponse: TypeAlias = List[StatevectorListResponseItem]

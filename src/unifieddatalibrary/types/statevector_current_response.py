...
__all__ = ["StatevectorCurrentResponse", "StatevectorCurrentResponseItem"]


class StatevectorCurrentResponseItem(BaseModel):
...
StatevectorCurrentResponse: TypeAlias = List[StatevectorCurrentResponseItem]

...
__all__ = [
    ...
    "LaunchsiteTupleResponseItem",
    "LaunchsiteTupleResponseItemLaunchSiteDetail",
    "LaunchsiteTupleResponseItemLaunchSiteDetailLocation",
]


class LaunchsiteTupleResponseItemLaunchSiteDetailLocation(BaseModel):
...
class LaunchsiteTupleResponseItemLaunchSiteDetail(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    location: Optional[LaunchsiteTupleResponseItemLaunchSiteDetailLocation] = None
    """
...
class LaunchsiteTupleResponseItem(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    launch_site_details: Optional[List[LaunchsiteTupleResponseItemLaunchSiteDetail]] = FieldInfo(
        alias="launchSiteDetails", default=None
    )
    """
...
LaunchsiteTupleResponse: TypeAlias = List[LaunchsiteTupleResponseItem]

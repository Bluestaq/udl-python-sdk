...
__all__ = ["EcpedrTupleResponse", "EcpedrTupleResponseItem", "EcpedrTupleResponseItemEcpedrMeasurement"]
...
class EcpedrTupleResponseItem(BaseModel):
    ...
    ecpedr_measurements: List[EcpedrTupleResponseItemEcpedrMeasurement] = FieldInfo(alias="ecpedrMeasurements")
...
EcpedrTupleResponse: TypeAlias = List[EcpedrTupleResponseItem]

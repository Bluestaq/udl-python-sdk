...
__all__ = ["SiteStatusTupleResponse", "SiteStatusTupleResponseItem"]


class SiteStatusTupleResponseItem(BaseModel):
...
SiteStatusTupleResponse: TypeAlias = List[SiteStatusTupleResponseItem]

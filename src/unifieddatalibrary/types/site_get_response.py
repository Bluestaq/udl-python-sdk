...
__all__ = ["SiteGetResponse", "SiteRemark"]
...
if PYDANTIC_V2:
    SiteGetResponse.model_rebuild()
    SiteRemark.model_rebuild()
else:
    SiteGetResponse.update_forward_refs()  # type: ignore
    SiteRemark.update_forward_refs()  # type: ignore

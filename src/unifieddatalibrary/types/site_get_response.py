...
class SiteGetResponse(BaseModel):
    ...
    site_operations: Optional[List[SiteOperation]] = FieldInfo(alias="siteOperations", default=None)

    site_remarks: Optional[List[SiteRemark]] = FieldInfo(alias="siteRemarks", default=None)
